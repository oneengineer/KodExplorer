...
define("app/src/desktop/main", [
  ...
  (Config = {
    ...
    (ui = a("../explorer/ui")),
    (ui.path = a("../../path/path")),
    (ui.fileLight = a("../explorer/fileLight")),
    (ui.fileSelect = a("../explorer/fileSelect")),
    (ui.fileListResize = a("../explorer/fileListResize")),
    (ui.options = a("../explorer/options"));
  $(document).ready(function() {
    rightMenu.initDesktop(),
      (G.userConfig.listType = "icon"),
      core.init(),
      ui.init(),
      ui.fileLight.init(),
      ui.fileSelect.init(),
    ...
    var b =
      '<div id="random-wallpaper">			<img class="flower animated-1000" src="' +
      G.staticPath +
      'images/common/desktop/fengche.png" title="' +
      LNG.setting_wall +
    ...
    c.bind("click", function() {
      ...
      var a = function(a) {
        ...
        $.get(
          G.appHost + "explorer/mkdir&repeat_type=replace&path=" + b,
          function() {
            $.get(
              G.appHost +
                "explorer/serverDownload&type=download&savePath=" +
                b +
                "&url=" +
                urlEncode(a)
            );
      ...
      core.api.randomImage(function(b) {
        ui.setWall(b, function() {
          ...
          $.get(G.appHost + "setting/set&k=wall&v=" + urlEncode(b)),
          a(b);
      });
    });
  });
