...
define("app/src/editor/ui", [], function(a, b, c) {
  var d = function() {
  ...
  return {
    init: function() {
      tree.init(),
        d(),
        Mousetrap.bind(["ctrl+s", "command+s"], function(a) {
          a.preventDefault(),
            (a.returnvalue = !1),
    ...
    fileHistory: function(a) {
      var b = G.project;
      if (
        ("undefined" != typeof G.sid && (b = b + "__" + G.sid),
        (b = "editorHistory_" + b),
        void 0 == a)
      ) {
        var c = LocalData.get(b);
        return (c = jsonDecode(c)), $.isArray(c) || (c = []), c;
      }
