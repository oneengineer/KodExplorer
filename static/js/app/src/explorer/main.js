/*! power by kodcloud ver4.37(2018-11-28) [build 1543400681336] */
define("app/src/explorer/main", [
  ...
  "../../common/taskTap",
  "../../common/core",
  "../../common/tpl/upload.html",
  "../../common/tpl/formMake.html",
  "../../common/core.tools",
  "../../common/core.upload",
  "../../common/core.api",
  "../../common/core.playSound",
  "../../common/core.formMake",
  "../../common/rightMenuExtence",
  "../../app/appBase",
  "../../app/editor",
  "../../app/openWith",
  "../../app/html",
  "../../common/tpl/copyright.html",
  "../../common/tpl/themeDIY.html",
  "../../common/rightMenu",
  "./ui",
  "./fileContent",
  "../../path/tpl/file/list.html",
  "../../common/tree",
  "../../path/pathOperate",
  "../../path/tpl/share.html",
  "../../path/tpl/fileinfo/fileInfo.html",
  "../../path/tpl/fileinfo/pathInfo.html",
  "../../path/tpl/fileinfo/pathInfoMore.html",
  "../../path/tpl/appEdit.html",
  "../../path/clipboard",
  "../../path/search",
  "../../path/tpl/search.html",
  "../../path/tpl/searchList.html",
  "../../path/path",
  "../../path/tpl/file/create.html",
  "./fileLight",
  "./fileSelect",
  "./fileListResize",
  "./headerAddress",
  ...
  (Config = {
    ...
    (ui = a("./ui")),
    (ui.tree = a("../../common/tree")),
    (ui.path = a("../../path/path")),
    (ui.fileLight = a("./fileLight")),
    (ui.fileSelect = a("./fileSelect")),
    (ui.fileListResize = a("./fileListResize")),
    (ui.headerAddress = a("./headerAddress")),
  ...
  $(document).ready(function() {
    ...
    rightMenu.initExplorer(),
      ...
      $(".init-loading")
        .fadeOut(450)
        .addClass("pop_fadeout"),
      a.async("lib/webuploader/webuploader-min", function() {
        core.uploadInit();
      }),
      "fileList" == b("type") &&
...
define("app/common/taskTap", [], function(a, b) {
  var c = {},
    ...
    g = function(a) {
      ...
      var d = $("." + b);
      "hidden" == d.css("visibility")
        ? c.display(!0).zIndex()
        : d.hasClass("aui-state-focus")
        ? c.display(!1)
        : c.zIndex();
    },
    h = function() {
      ...
      var o = function(d) {
          ...
          var e =
              a.get(0).getBoundingClientRect().top -
              $sizeInt(a.css("margin-top")),
            g = d.clientX - i + j;
          $("body").prepend("<div class='dragMaskView'></div>"),
            c.css({ width: k + "px", top: e, left: g }),
            a.css("opacity", 0);
        },
        p = function(d) {
          if (h) {
          ...
          if (!a.is(":animated") || d != c) {
            ...
            var g = a.width(),
              ...
              i = a
                .clone(!0)
                .insertAfter(a)
                .css({ "margin-right": "0px", border: "none" })
                .addClass("insertTemp");
            "left" == f
              ? a.after(h).css("width", "0px")
              : (a.before(h).css("width", "0px"), h.before(i)),
              a.animate({ width: g + "px" }, e),
              i.animate({ width: "0px" }, e, function() {
        ...
        r = function() {
          (h = !1),
            ...
            void 0 != c &&
              ((j = a.get(0).getBoundingClientRect().left),
              c.animate({ left: j + "px" }, e, function() {
    ...
    i = function(a) {
      ...
      switch ((h > i && (c = Math.floor(g / h) - 12), a)) {
        case "add":
          $(".task-tab .tabs .this")
            .css("width", "0")
            .animate({ width: c + "px" }, e);
        case "close":
          f.animate({ width: c + "px" }, e);
          break;
        case "resize":
          f.css("width", c + "px");
      }
    ...
    l = function(a) {
      $(".task-tab #" + a).animate({ width: 0 }, e, function() {
        if (
          ($(".task-tab #" + a).remove(),
          i("close"),
          0 == $(".tabs .tab").length && !core.isApp("desktop"))
        ) {
          var b = 31;
          $(".task-tab").animate(
            { bottom: "-" + b + "px" },
  ...
  return {
    ...
    init: function() {
      var a =
        '<div class="task-tab"><div class="tabs"><div class="last" style="clear:both;"></div></div></div>';
      $(a).appendTo("body"),
...
!(function($) {
  !(function(
    ...
    $[i](t, [r, o, e, c, f, a, u, d, v, s, E, h, C, l], function(n) {
      ...
      var ba = function() {
          ($[I][m] = n),
            ...
            ($[y][B][k] = !F),
            T == $[x][D]
              ? (($[y][B][V] = !F), ($[y][B][z] = !F), ($[y][B][Y] = !_))
              : (($[y][B][V] = !_), ($[y][B][z] = !_), ($[y][B][Y] = !F));
        },
        Sa = function() {
          ba(),
            W != typeof $[x] &&
              (F != $[x][U] && $[Q](j)[q](),
              $[x][U] || $[H][Z]($n) || F == $[H][Z](nn) || $[Q](tn)[q](),
              $[x][rn] && on == $[x][rn][en] && ($[Q][fn][B][cn] = !F),
              ma()),
            $[an]() &&
              ($[Q](dn)[un](vn),
              n[sn](En, function() {
            ...
            $[Q](Hn)[Rn](wn, function(n) {
              if (_ == $[Q](n[Tn])[bn](kn)[Pn])
                try {
                  $[Q][yn][Jn]();
                } catch (n) {}
            }),
            ...
            $[Q][fn][B][cn] &&
              $[Yn]([Wn, Un, qn, Sn, jn, Zn, $i, ni], [ii, ti, ri, oi]),
            $[Q](ci)[ei](fi, ai),
            $[Q][ui]({ headers: { "X-CSRF-TOKEN": $[vi][di](si) } }),
            $[Q](Ei)[wn](function() {
              var n = $[Q](this)[ei](hi);
              $[vi][Ci](hi, n), $[I][pi][li]();
            }),
            $[Q](Ei)[Fn]({ padding: Ai }),
            $[Q](Oi + $[vi][di](hi) + Gi)[Fn]({ background: gi, color: bi }),
            $[H][Si](),
            $[H][Ii][mi]();
          for (var i = _; i < $[I][Ji][Pn]; i++)
            try {
              $[I][Ji][i]();
            } catch (t) {
              $[R][yi](Bi, t);
        ...
        ma = function() {
          var n = $[I][pi],
            i = n[ki] ? Fi + n[ki] : Vn;
          ($[x][Xi] = n[_i] + Mi + n[Qi] + i + Ni),
            ($[x][Ri] = $[Hi]($[x][Xi], Ni) + n[Pi][wi](Ti, Vn));
          var t = $[x][Di][wi](Ti, Vn);
          $[x][Xi] + $[xi](t, Ni) != $[x][Ri] &&
            ($[x][Xi] = $[Hi]($[x][Ri], t) + Ni),
            ($[x][Vi] = $[x][Ri] + zi),
            ...
            n[sn]([tt, rt], function() {
              ...
              n[et]({
                ...
                showTimeout: function() {
                  var n = ht;
                  return (
                    $[Q](this)[ei](Ct) && (n = $[lt]($[Q](this)[ei](Ct))), n
                  );
                },
                content: function() {
                  var n = $[Q](this)[pt](At);
                  if ($[Q](this)[ei](Ot)) {
                    var i = $[Q]($[Q](this)[ei](Ot));
                    n = i[Gt](gt) || i[Gt](bt) ? i[St]() : i[Hn]();
                  }
                  return (n = n ? n : Vn), n[wi](mt, It);
                }
              }),
                $[Q](dn)
                  [Rn](Kn, function() {
      ...
      return {
        ...
        getPathIcon: function(n, i) {
          if (((i = void _ == i ? Vn : i), Nt == $[Q][Rt](n))) {
            var t = $[Ht]($[Ht](n), Ni);
            if (((n = {}), wt != t[Pt](_, F) || t[Tt](Ni)[Pn] > F))
              return { icon: Vn, name: Vn };
            (n[Dt] = t[xt](Vt)), (n[zt] = t[Tt](Fi)[F]);
          }
          var r = {};
          (r[$[x][Yt]] = { icon: Wt, name: $[qt][Ut] }),
            (r[$[x][jt]] = { icon: Zt }),
            (r[$[x][$r]] = { icon: nr }),
            (r[$[x][ir]] = { icon: Wt }),
            (r[$[x][tr]] = { icon: rr, name: $[qt][rr] }),
            (r[$[x][or]] = { icon: er, name: $[qt][cr] }),
            (r[$[x][fr]] = { icon: ar, name: $[qt][ur] }),
            (r[$[x][dr]] = { icon: vr, name: $[qt][sr] });
          var o = r[n[Dt]];
          return (
            n[Dt] == $[x][Yt] && $[x][Er] != n[zt]
              ? (o = { icon: hr, name: i })
              : n[Dt] == $[x][jt] && Cr == n[lr] && (o = { icon: Zt }),
            void _ == o && (o = { icon: Vn, name: Vn }),
            void _ == o[pr] && (o[pr] = i),
            o
          );
        },
        isFileView: function() {
          var n = $[x][Ar] + Or + $[x][Gr];
          return gr == n || br == n ? !_ : !F;
        },
        isSystemPath: function(n) {
          var n = $[Ht]($[Ht](n), Ni);
          if (void _ == n || wt != n[Pt](_, F) || n[Tt](Ni)[Pn] > F) return !F;
          var i = n[xt](Sr),
            t = [$[x][Yt], $[x][$r], $[x][tr], $[x][or], $[x][fr], $[x][dr]];
          return -F !== $[Q][P](i[_], t) ? !_ : !F;
        },
        pathPre: function(n) {
          if (((n = $[Ht]($[Ht](n), Ni)), void _ == n || wt != n[Pt](_, F)))
            return Vn;
          var i = n[xt](mr);
          return i[_];
        },
        ...
        pathThis: function(n) {
          if (!n || Ni == n) return Vn;
          var i = $[Hi](this[Fr](n), Ni),
            t = i[Xr](Ni),
            r = i[_r](t + F);
          if (_ == r[Mr](Qr)) {
            r = $[Nr](r[_r](r[Mr](Rr)));
            var o = r[Tt](Ni);
            (r = o[o[Pn] - F]), Vn == r && (r = o[o[Pn] - Hr]);
          }
          return r;
        },
        pathClear: function($) {
          if (!$) return Vn;
          var n = $[wi](wr, Ni);
          return (n = n[wi](Pr, Ni)), (n = n[wi](Tr, Ni));
        },
        ...
        pathExt: function(n) {
          var i = $[Ht](n, Ni);
          return (
            -F != i[Xr](Ni) && (i = i[_r](i[Xr](Ni) + F)),
            -F != i[Xr](Or) ? i[_r](i[Xr](Or) + F)[Dr]() : i[Dr]()
          );
        },
        ...
        path2url: function(n, i) {
          ...
          var t,
            r = this[Fr](n);
          return (
            $[x][U] && i && r[Pt](_, $[x][Wr][Pn]) == $[x][Wr]
              ? (t =
                  r[Pt](_, $[x][Ur][Pn]) == $[x][Ur]
                    ? $[x][Ri] + this[qr](r[wi]($[x][Ur], Vn))
                    : $[x][Xi] + this[qr](r[wi]($[x][Wr], Vn)))
              : ((t = $[x][Vi] + jr + $[x][Zr] + Rr + $[xr](r)),
                W != typeof $[x][$o] &&
                  (t =
                    $[x][Vi] + no + $[x][hr] + io + $[x][to] + Rr + $[xr](r))),
            t
          );
        },
        pathCommon: function(n) {
          if (zr == n[_r](_, Yr)) return $[xr](n);
          if (n[_r](_, $[x][Yt][Pn]) == $[x][Yt]) return $[xr](n);
          var i = this[Fr](n),
            t = $[xr](i);
          return (
            W != typeof $[x][$o] &&
              (t = $[xr]($[x][Yt] + Fi + $[x][hr] + Ni + $[x][ro][pr] + i)),
            t
          );
        },
        isApp: function(n) {
          if (W == typeof $[oo]) return !F;
          var i = $[oo][eo];
          return Nt == typeof n
            ? i == n
            : $[Q][co](n) && -F !== $[Q][P](i, n)
        ...
        pathReadable: function(n) {
          if (fo != typeof $[x][ao]) return !_;
          for (var i = $[x][ao][uo], t = _; t < i[Pn]; t++)
            if (i[t][vo] == n)
              return void _ == i[t][so] || F == i[t][so] ? !_ : !F;
          i = $[x][ao][Eo];
          for (var t = _; t < i[Pn]; t++)
            if (i[t][vo] == n)
              return void _ == i[t][so] || F == i[t][so] ? !_ : !F;
          return !_;
        },
        ...
        authCheck: function(n, i) {
          return $[x][U]
            ...
            : $[Oo][Ao](n) && F == $[Oo][n]
            ? !_
            : (i && ((i = i === !_ ? $[qt][Go] : i), $[bo][go](i, !F)), !F);
        },
        authCheckGroup: function(n, i) {
          if (((i = i || $[x][So]), F == $[x][U] || !$[x][mo])) return !_;
          var t = i[xt]($[Io](Ni + $[x][jt] + Jo));
          if (t && Hr == t[Pn] && $[x][mo][t[F]]) {
            var r = $[x][mo][t[F]];
            if (!r[Ao](n) || F != r[n]) return !F;
          }
          return !_;
        },
        ...
        fileGet: function(n, i, t) {
          ...
          W != typeof $[x][$o] &&
            (o =
              ...
              Wo +
              $[xr](n)),
            (n[jo](Yo) >= _ || n[jo](Zo) >= _) && (o = n),
            $[Q][$e]({
              url: o,
              dataType: ne,
              error: function(n, i, r) {
                $[H][ie](n, i, r), te == typeof t && t();
              },
              success: function(n) {
                n[re] &&
                  te == typeof i &&
                  (F == n[pt][oe] && (n[pt][ee] = $[ce](n[pt][ee])),
                  i(n[pt][ee], n, o)),
        ...
        fileLink: function(n, i) {
          if (
            ((n = this[Fr](n)), $[x][U] && n[Pt](_, $[x][Wr][Pn]) == $[x][Wr])
          ) {
          ...
          this[se](r, function(t) {
            ...
            return r
              ? void (te == typeof i && i(r, n))
              : void $[bo][go]($[qt][he] + Ce + $[qt][le], !F);
          });
        },
        setting: function(n) {
          void _ == n && (n = $[x][U] ? pe : hr);
          var i = Ae,
            t = Ae;
          $[an]() && ((i = Oe), (t = Oe)),
            $[xn][Dn](Ge)
              ? $[xn][Dn](Ge, function(i) {
                  i[be][ge](n), $[Q][fn][Ko][me][Se](!_);
                })
              : $[Q][fn][Ie]($[x][Vi] + Je + n, {
                  id: me,
                  fixed: !_,
        ...
        copyright: function() {
          ...
          r[Ke][fn]({
            ...
            padding: on,
            fixed: !_,
            content: t({ LNG: $[qt], G: $[x] })
          }),
            r[Q](Xe)[un](_e);
        },
        qrcode: function(n, i) {
          Me == n[_r](_, Hr) && (n = $[x][Vi] + n[_r](Hr));
          var t = $[x][Vi] + Qe + $[Ne]($[xr](n)),
            r = Re + $[Ne](n) + He + n + we + t + Pe;
          $[Q][fn]({
            follow: i,
            fixed: !_,
            resize: !F,
        ...
        openApp: function(n) {
          if (ec == n[Rt]) {
            ...
            var t = {
              ...
              r = n[ee];
            if (lc == $[Q][pc]()[_i] && zr == $[Q][pc](r)[_i])
              return void $[I][Ie](r);
            var o = $[xn][Dn]();
            Ac == $[H][Oc](r)
              ? ((t[ee] = $[H][Gc](r)), o[Q][fn](t))
              : o[Q][fn][Ie](r, t);
          } else {
            var e = n[ee];
            $[Io](wt + e + gc);
        ...
        openPath: function(n) {
          $[H][ho](Jc) ? $[yc][vo][Ko](n, go) : $[H][Jc](n);
        },
        explorer: function(n, i) {
          void _ == n && (n = Vn), void _ == i && (i = $[H][Bc](n));
          var t = $[x][Vi] + Kc + n;
          W != typeof $[x][$o] &&
            (t = $[x][Vi] + Lc + $[x][hr] + io + $[x][to] + Rr + n);
          var r = $[xn][Dn](),
            o = r[Q][fn][Ie](t, {
              className: kc,
              resize: !_,
            ...
            e = Et * r[Q](Xc)[Pn];
          o[Mc][_c][Fn]({ left: Qc + e + Nc, top: Qc + e + Nc });
        },
        explorerCode: function(n) {
          void _ == n && (n = Vn);
          var i = $[x][Vi] + Rc + n;
          W != typeof $[x][$o] &&
            (i = $[x][Vi] + Hc + $[x][hr] + io + $[x][to] + wc + n),
            $[I][Ie](i);
        },
        setSkinFinished: function() {
          var n = $[Q](Pc)[ei](Tc);
          n && ($[Q](Dc)[ei](xc, n), $[Q](Pc)[q]());
        },
        setSkin: function(n) {
          $[Vc][Ci](zc, n), ($[x][rn][zc] = n);
          var i = $[x][cc] + Yc + n + Wc + $[x][Uc];
          i != $[Q](Dc)[ei](xc) && $[Q](dn)[qc](jc + i + Zc), this[Si]();
        },
        setSkinDiy: function() {
          if ($[x][rn]) {
            var i = $[Vc][di](zc),
              t = $f,
              r = $[Vc][nf](t);
            fo != typeof r && fo == typeof $[x][rn][tf] && (r = $[x][rn][tf]),
              fo != typeof r &&
                ((r = {
                  bgBlur: F,
                  bgImage: $[x][cc] + rf,
        ...
        language: function(n) {
          $[vi][Ci]($t, n, it), $[I][pi][li]();
        },
        fullScreen: function() {
          Ef == $[Q](dn)[ei](hf) && $[H][Cf](), $[Q](dn)[ei](hf, Ef);
          var n = $[xn][Dn](),
            i = n[ln][lf];
          i[pf] ? i[pf]() : i[Af] ? i[Af]() : i[Of] && i[Of]();
        },
        ...
        uploadCheckSize: function(n) {
          if (ca == $[H][fa]) return !_;
          var i = $[x][ao][aa] || $[x][ao][ua];
          return i && _ != i[da] && va * i[da] * va * va - i[sa] < n ? !F : !_;
        },
    ...
    $("#,+2-$'0"),
    $("1&J$"),
    $("/+,'0$;0O-$'2O&0$-/+,'0$;0O-$'2O62M-$'2S/+,'0$;0O-$'2O&0$-"),
    $("0,2+360(.0"),
    $("3(6P1(66"),
    $("+,'0$;0O-$'2O&0$-"),
    $(")(.$'06"),
    ...
    $("60(026"),
    $(
      "rstuvwSn'$0aa:NNIPRYY:PH?RYIN:8:Hqxtuyz{fM.*g|",
      90,
      91,
      92,
      93,
    ...
    $("f(S3.$%^", 110, ""),
    $(110, "S6^", 110, ""),
    $(110, "S0(.9$0^", 110, "IM1('5", 110, "gf&-9S6.+^", 110, ""),
    $(110, "S6071$^", 110, "M,.#$.ac);S6,1&#ST$$$j", 110, "*gf*(g"),
    $("E.+,#$"),
    30,
    $("())"),
    $("())I60,.$"),
    ...
    $(110, "S6071$^", 110, "F&#03a"),
    $(110, "gf*#&Jgf*#&Jgf#&JS+1(66^", 110, "6)(+$O&'%,", 110, "g"),
    $("f*#&Jgf*#&Jg"),
    $("#(0$"),
    $("0&-$I07)$"),
    $("C"),
  ...
  !(function(
    ...
    $[r](t, [], function(n) {
      ...
      var Br = an,
        ...
        Wr = function() {
          var n = { A: ln, O: Rn, P: Vn, Q: bn, R: Fn, S: Mn, T: gn },
            t = mn + n[Yr],
            o = yn + t + Dn + $[vn][t] + Pn;
          l == Yr && $[v](o)[_n](Tn),
            $[v](Bn)
        ...
        Kr = function(n, r) {
          ($[s][lr] = { A: p, O: Rr, P: Vr, Q: br, R: Fr, S: N, T: N }),
            ($[s][Mr] = { A: gr, O: Q, P: mr, Q: yr, R: Dr, S: N, T: N });
          var t,
            o,
            c = $[s][lr],
            i = $[s][Mr],
            ...
            u = p;
          if (
            (Pr == r ? ((t = n[_r]), (o = c[Yr])) : ((t = n[_r]), (o = i[Yr])),
            N == o)
          )
            f = t;
          else
    ...
    $("7(278$+,#$"),
    $(
      "9:;-<=>:?@&50A(B?5A((C7$&DE4FAG.4(H4$$I&@(#JK51),?-'6')'68,),D,.L%,J=C'2L5,0:MN4G8556O1GBO)G8).G;PQG>RS=TUV+F<QG;WA+"
    ),
    $("K7XYZ"),
    $("1('J"),
    $(">"),
    ...
    $("9"),
    $("5$.2&,'A5&)A"),
    $("o2)(']+1(22cp5$.2&,'X5&)p]&#cp"),
    $("pqo&]+1(22cp%,'0X&+,']&+,'XN$dpqo*&q"),
    $("o*2)('q"),
    $("&'2$.0`%0$."),
    $("/-$'4X2d20$-X(G,40"),
    $("1&5$"),
    ...
    $(",)$'B&'#,_"),
    $("5$.2&,'H)#(0$r&)"),
    $("o#&5]+1(22cp5$.2&,'X1&+$'2$pqo(]+1(22cp1&'$p]7.$%cp"),
    $("pqstuvo*(qo*#&5q"),
    $("())$'#"),
    $("%&'#"),
    $("_.()"),
    ...
    $("24)),.0X2)(+$X',0"),
    $(".$-,5$"),
    $("/-$'4X2d20$-X(G,40^/-$'4X1$%0]\\(G,40"),
    $(
      "\\).,J.(-2]/2$00&'JA(G,40^\\).,J.(-2]/2$00&'JA7,-$)(J$^\\).,J.(-2]/7,-$A)(J$"
    ),
    $("&+,'"),
    $("700)"),
    4,
    ...
    $("pqo*&q"),
    $("o&-J]2.+cp"),
    $("p]#.(JJ(G1$cp%(12$p],'#.(J20(.0cp.$04.']%(12$xpq"),
    $("+,.$A0,,12A2d20$-8(0("),
    $("+,.$A0,,12A5$.2&,'Cd)$"),
    $("2d20$-8(0("),
    $("5$.2&,'Cd)$"),
...
!(function($) {
  !(function(
      ...
      return (
          ...
          : (($[m][y] = N), ($[m][g] = D), ($[m][H] = Q)),
        {
          serverDwonload: function(n, i) {
            ...
            var t = $[h](U),
              o = t[W](P);
            if ((t[W](z)[q](V), !n)) return void $[M][Y]($[m][Z], !x);
            if (e == $[r][u]) return void $[M][Y]($[m][j], !x);
            $n != n[nn](k, tn) && cn != n[nn](k, rn) && (n = on + n);
            var f = $[en](),
              d = un + f + an + n + fn + $[R][dn](n) + En + $[m][vn] + sn;
            o[W](Cn)[K] > k ? $[h](d)[Gn](o[W](An)) : o[hn](d);
            var E,
              v,
              s,
              C = k,
              ...
              $[h][Wn]({
                ...
                success: function(n) {
                  var i = V,
                    t = n[jn];
                  if (E) {
                    if (!n[ui]) return void A[pn]($[m][Ai]);
                    if (t) {
                      if (((t[hi] = $[bi](t[hi])), (t[Mn] = $[bi](t[Mn])), s)) {
                        var c = t[hi] - s[hi],
                          r = c / (t[Mn] - s[Mn]);
                        if (C > li * r) {
                          var o = C;
          ...
          upload: function() {
            $[h](Ni)[Ti]();
            var n = i();
            if (($[Qi][Di](Fi, n), $[Qi][Di](Ri, Si), k != $[h](Ni)[K]))
              return void $[h][Wi][Ui][Pi][xi](!k);
            var t = $[zi][qi]($[Vi]);
            $[h][Wi]({
              padding: Yi,
              width: Mi,
          ...
          init: function() {
            var c = function(n, i) {
              ...
              a = function(n) {
                ...
                return $[r][cc][tc] &&
                  ...
                  ? x == n[fc]
                    ? void t[dc]()
                    : n[vc][Ec] && !n[vc][Ec][sc + n[Cc]]
                    ? void t[dc]()
                    : (o(n[Ac][Gc], function(c) {
                        if (k == n[Cc])
                          $[h][Wn]({
                            url: i(),
                            dataType: Zn,
            ...
            $[Jc][mc][Bc]({ "before-send": Ec }, { checkChunk: a }),
              ($[p][_c] = $[Jc][Xc]),
              $[Fn](function() {
                if (!$[p][Oc] || yc == typeof $[Ic]) {
                  var i = gc + $[wc]();
                  n[Hc](i, function(n) {
                    $[p][Oc] = !k;
                    try {
            ...
            ($[p][Qi] = f({
              ...
              $[h](rt)
                [Vc](On)
                [zc](On, function() {
                  $[h](rr)[Nn](), (Ae = k), (t = $[h](or)[K]), E();
                }),
              $[h](er)
                [Vc](On)
                [zc](On, function() {
                  $[h][ur]($[Qi][ar](), function(n, i) {
                    $[Qi][fr](i), $[Qi][dr](i);
                  }),
                    $[h](or)[ur](function() {
                      $[h](this)[Nn]();
            ...
            var d,
              ...
              C = function(n, i) {
                ...
                yc == typeof n[mr]
                  ...
                  : n[mr][K] <= c
                  ? n[mr][_r]([$[wc](), t])
                  : ((n[mr] = n[mr][zt](x, c)), n[mr][_r]([$[wc](), t]));
                var r = n[mr][n[mr][K] - x],
                  o = n[mr][k],
                  e = (r[x] - o[x]) / (r[k] - o[k]);
                k >= e && (e = k);
                var u = $[Ki][pi](e);
                return (u = u ? u : k), (e = u + Li), (v = e), e;
              },
              G = [],
              A = function(n) {
                $[In](d),
            ...
            $[Qi][gr](wr, function(n) {
              ...
              [gr](Sr, function() {
                if (b >= l)
                  for (var n = k; n < L[K]; n++) $[h](bn + L[n] + Xn)[On]();
                (b = k), (L = []);
              })
              [gr](xr, function(n) {
                if (($[h](Ni)[Ti](), !$[R][F]()))
                  return $[Qi][fr](n), void $[Qi][dr](n);
                var i;
                try {
                  (i = n[Gc][Gc][Ur]),
                    void k != n[Gc][Gc][Wr] &&
                ...
                if (
                  ((n[Ur] = i),
                  n[Gc] && n[Gc][Gc] && x == n[Gc][Gc][Pr] && n[Gc][Gc][Ur])
                )
                  return (
                    $[Qn][xn][zr][qr]($[r][pt] + n[Ur]),
                    $[Qi][fr](n),
                    void $[Qi][dr](n)
                  );
                var o = n[Ur];
              ...
              [gr](ro, function(n, i, t) {
                if (n[vc] && !$[R][oo](n[vc][hi])) {
                  var c = n[vc];
                  return $[Qi][fr](c), $[Qi][dr](c), void X(c, $[m][eo]);
                }
                $[h](bn + n[vc][Rr])[jn](vc, n[vc]);
                var r = $[zn](n[vc][Ur]);
                (void k == r || yc == r) && (r = V),
                  (i[Ur] = r),
                  (i[hc] = n[vc][hc]),
              ...
              [gr](Lc, function(n, i) {
                var c = C(n, i),
                  r = (_i * i)[Oi](x) + Xi,
                  o = fo == r ? $[m][Eo] : r + vo + c + Ii;
                $[h](br)[pn]($[m][B] + pr + Ae + Kr + t + so + v + Ii),
                  $[Lr][Co](Ae + Kr + t + vo + o + $c + v + Ii);
                var e = $[h](bn + n[Rr]),
                  u = e[W](Go);
                u[K] ||
                  (u = $[h](Ao)
                  ...
                  e[W](Cr)[pn](o),
                  u[ki](Bi, r),
                  n[ho] && n[ho][fi] && (n[bo] = n[ho]);
              })
              [gr](lo, function($, n) {
                if ((($[vc][ho] = n), !n[ui])) return ($[po] = !k), !x;
                try {
                  $[vc][Ur] || G[_r](n[fi]);
                } catch (i) {}
              })
              [gr](Ko, function(n) {
                var i = n[bo] || n[ho] || {};
                if (i && i[jn])
                  if (i[ui] && i[fi]) Ae++, _(n, $[m][i[jn]], i[fi]);
                  else {
                    var t = $[m][Lo] + $[m][g] + ko + i[jn] + Bo;
                    X(n, t);
                  }
              })
              [gr](mo, function(n, i) {
                var t = n[bo] || n[ho] || {};
                if (t[fi]) return void _(n, $[m][t[jn]], t[fi]);
                var c = Jo == typeof t ? t[jn] || t[_o] || V : t;
                if (((c += V), c && -x != c[Xo](Oo)))
                  return (
                    $[h][ur]($[Qi][ar](), function(n, i) {
                      $[Qi][fr](i), $[Qi][dr](i);
                ...
                if (t && t[jn] && t[ui] === !x)
                  return (o = t[jn]), void X(n, o);
                var r = Zt;
                if ((n[Io] || (n[Io] = k), n[hi] < go && n[Io] <= r))
            ...
            ($[Yo] = !x),
              ($[Mo] = function() {
                if (k == $[Yo]) {
                  if ((($[Yo] = !k), !$[R][F](void k, !x))) return;
                  var n = Zo + $[m][jo] + $e;
                  $[ne][Y](n), $[h](ie)[ki]({ background: te, opacity: ce });
                }
                J && $[p][In](J);
              }),
              ($[re] = function(n) {
              ...
              ($[ee] = function(n) {
                try {
                  if (((n = n[ue] || n), $[R][F]()))
                    if (n[fe][ae][K] > k && n[fe][ae][k][wi])
                      $[R][$t](), $[R][de](Ee);
                    else {
                      var i = n[fe][ve](se);
                      i && cn == i[Ce](k, rn) && $[Qn][xn][zr][Ge](i);
                    }
                  $[ot](n);
                } catch (n) {}
                $[Yo] && (($[Yo] = !x), $[ne][oe]());
    ...
    $("77<_"),
    $("b#&^[&#>c"),
    $("c[+1(33>c&4$-cdb#&^[+1(33>c&'%,cdb3)('[+1(33>c4&41$c[4?41$>c"),
    $("cd"),
    $(")(48`8&3"),
    $("b*3)('db3)('[+1(33>c3&G$cdXAb*3)('db3)('[+1(33>c34(4$cd"),
    $("0)1,(#I.$(#?"),
    $(
      "b*3)('db([+1(33>c.$-,^$[%,'4C&+,'[&+,'C.$-,^$c[8.$%>ce(^(3+.&)4a^,&#LXQcdb*(db#&^[34?1$>c+1$(.aA,48cdb*#&^db*#&^db*#&^d"
    ),
    $("/&4$-"),
    $("&'3$.4f$%,.$"),
    $("/&4$-a$gLXQ"),
    ...
    $("())$'#`,"),
    $(
      "b#&^[+1(33>c).,:.$33[).,:.$33C34.&)$#[(+4&^$cdb#&^[+1(33>c).,:.$33CA(.c[.,1$>c).,:.$33A(.c[34?1$>cB&#48a[Xij4$64C(1&:'a.&:84jcdb*#&^db*#&^d"
    ),
    $("/).,:.$33CA(."),
    $("A&'#"),
    $("[/.$-,^$"),
    ...
    $("/%&1$C0)1,(#CA,6[/4(AC0)1,(#"),
    $("48&3"),
    $("/%&1$C0)1,(#CA,6[/4(AC#,B'1,(#"),
    $("/%&1$C0)1,(#CA,6[/0)1,(#CA,6"),
    $("8&##$'"),
    $("/%&1$C0)1,(#CA,6[/#,B'1,(#CA,6"),
    $("]$?n'4$."),
    $("/#,B'1,(#CA,6[p'(-$>0.1q"),
    $("3$.^$._B,'1,(#"),
    $("/#,B'1,(#CA,6[&')04"),
    $("48&39(48"),
    $("/%&1$C0)1,(#CA,6[/#,B'1,(#CA,6[/#,B'1,(#C34(.4"),
    $("/%&1$C0)1,(#CA,6[/#,B'1,(#CA,6[/#,B'1,(#C34(.4C(11"),
    $("3$.^$.C#B,'1,(#C4$64(.$("),
    $("rWX)6"),
    $("WsX)6"),
    10,
    $("#,B'1,(#"),
    $("b4$64(.$([34?1$>tB&#48ar;X)6j8$&:84aWuX)6jtdb*4$64(.$(d"),
    $("3)1&4"),
    $("/3$.^$.C#B,'1,(#C4$64(.$([4$64(.$("),
    $("v"),
    $("(##f044,'"),
    ...
    $("/0)1,(#$.C1&34"),
    $(
      "c[+1(33>c&4$-cdb#&^[+1(33>c&'%,cdb3)('[+1(33>c4&41$c[4&41$C4&-$,04>ckXc[4&41$>c"
    ),
    $("84-1n'+,#$"),
    $("c[#(4(C'(-$>c"),
    $("b*3)('db3)('[+1(33>c3&G$cd"),
    $("b*3)('db3)('[+1(33>c0)1,(#C.$4.?cd"),
    $("b*3)('db3)('[+1(33>c34(4$[0)1,(#C1,(#&':c[4&41$C4&-$,04>ckXcd"),
    $("'$Bm&1$"),
    $(").$)$'#"),
    $("0)1,(#f$%,.$l$'#"),
    $("0)1,(#H8$+]l&G$"),
    ...
    $("/).,:.$33[/).,:.$33CA(."),
    $(
      "b#&^[+1(33>c).,:.$33[).,:.$33C34.&)$#[(+4&^$cdb#&^[+1(33>c).,:.$33CA(.c[.,1$>c).,:.$33A(.c[34?1$>cB&#48a[Xicdb*#&^db*#&^d"
    ),
    $("3$.^$._(4("),
    $("3$.^$._(4(E(34"),
    $("0)1,(#w++$)4"),
    ...
    $(
      ...
      93,
      93,
      "b&[+1(33>c&+,'C+1,0#[+1,0#z[-,^$E$%4E,,)cdb*&d",
      93,
      93,
      93,
      93,
      ...
      93,
      93,
      "b#&^[+1(33>c+1,0#C-,^$0)cdb&[+1(33>c-,^$`,)E,,)[&+,'C+&.+1$C(..,BC0)cdb*&db*#&^d",
      93,
      93,
      93,
      93,
    ...
    d = function() {
      ...
      if (a.params.fileSelect) {
          ...
          g = function(a) {
            ...
            if ("makeUrl" == c) {
              ...
              for (
                ...
                var j = e[i];
                (g[j] = { name: core.pathThis(j), url: !1, path: j }),
        ...
        var j = function(a) {
          ...
          l = function(a) {
            0 == a.length ||
            ("all" == b && 0 == a.file.length && 0 == a.folder.length)
              ? f("selectChange", 0)
              : f("selectChange", a);
          };
      }
    ...
    d(),
    {
      pathSelect: function(a, b) {
            ...
            ok: function() {
              if ("function" == typeof a.callback) {
                ...
                if (b) {
                  var c = b;
                  if (
                    (a.single && "all" != a.type && (c = b[0]),
                    a.makeUrl && "file" == a.type)
                  )
                    return i("makeUrl", c), !1;
                  a.callback(c);
        ...
        (f += "&forceWap=0&fileSelect=" + a.type),
          ...
          (e.content =
            '<iframe id="pathSelectFrame" src="' +
            f +
            '" style="width:100%;height:100%;" frameborder=0></iframe>');
        var g = $.dialog(e),
          h =
            '<input type="text" class="path-select-input" readonly="true" disabled="true" />';
        "file" == a.type &&
          (h += '<span class="label label-primary">' + a.allowExt + "</span>"),
        ...
        var i = function(a, b) {
          ...
          j = function(b) {
            ...
            var d = c.type,
              e = c.data;
            if ("makeUrl" == d)
              a.callback(e), $.artDialog.list.pathSelectApi.close();
              ...
              if (!e)
                return (
                  h.addClass("disable"), g.data("result", !1), void g.val("")
                );
        ...
        window.MessagerParentInit
          ? messengerParent.addTarget(k, "ParentPage")
          : ((window.messengerParent = new Messenger("ParentPage", c)),
            messengerParent.addTarget(k, "ParentPage"),
...
define("app/common/core.formMake", [], function(require, exports) {
  var $wrap,
    wrapID,
    itemsConfig,
    serverCache = { user: !1, group: !1, role: !1 },
    bindEvent = function() {
      ($wrap = $("#" + wrapID)),
        $wrap.find(".tab-group .tab-item").length > 1
          ? bindGroupTab()
          : $wrap.find(".tab-group").addClass("hidden"),
        ...
        $wrap.find(".form-row.form-html [data-link-type]").exists() &&
          loadLinkData(),
        $wrap
          .find(".form-row.error [name]")
          .die("change")
          .live("change", function() {
            $(this)
              .parents(".form-row.error")
              .removeClass("error");
          }),
        $wrap
          .find(".form-userSelect")
          .die("click")
          .live("click", function() {
        ...
        (f = jsonDecode(f)),
          "switch" == e
            ...
            : "checkbox" == e &&
              ...
              (d = d.join(",")));
        for (
          var g = f.include && f.include.split(","),
            h = (f[d] || "") && f[d].split(","),
            i = 0;
          i < g.length;
          i++
      ...
      $wrap.find(".form-dateTime input + .btn").bind("click", function() {
        ...
        require.async(
          [
            ...
            "lib/jquery.datetimepicker/jquery.datetimepicker.js"
          ],
          function() {
            ...
            $wrap.find(".form-dateTime input").each(function() {
              ...
              fromTime &&
                (options.minDate = fromTime.match(/[a-zA-z()]/)
                  ? eval(fromTime)
                  : fromTime),
                $(this)
          ...
          d.attr("multiple")
            ? "all" == a
              ...
              : ($(this).toggleClass(b),
                f.toggleClass(c),
                $(this).hasClass(b)
                  ? d.find("[data-type=all]").removeClass(b)
                  : d.find("." + b).exists() ||
                    d.find("[data-type=all]").addClass(b))
            : (d.find("button").removeClass(b),
              $(this).addClass(b),
              e.addClass(c),
              f.removeClass(c));
    ...
    loadDataServer = function(a, b) {
      ...
      return null == serverCache[a]
        ? void Hook.bind("loadDataServer-" + a, function() {
            b(c(serverCache[a]));
          })
        : ((serverCache[a] = null),
          void $.ajax({
            ...
            success: function(d) {
              return d.code
                ? ((serverCache[a] = d.data),
                  b && b(c(serverCache[a])),
                  void Hook.trigger("loadDataServer-" + a))
                : void Tips.tips(d);
            }
          }));
    },
      ...
      var c = function(a) {
          var b = function(a) {
              for (var c = 0; c < a.length; c++)
                void 0 != a[c]
                  ? ((a[c].pid = a[c].parentID),
                    (a[c].id = a[c].groupID),
                    delete a[c].children,
                    delete a[c].parentID,
                    delete a[c].groupID,
                    a[c].child &&
                      ((a[c].children = a[c].child),
                      delete a[c].child,
                      b(a[c].children)))
                  : delete a[c];
            },
          ...
          for (var e in d) {
            var f = d[e],
              g = f.parentID;
            if (d[g])
              d[g].child || (d[g].child = []), d[g].child.push(d[f.groupID]);
            else {
              var h = d[f.groupID];
              h && c.push(h);
            }
          ...
          view: {
            ...
            addDiyDom: function(a, b) {
              ...
              if (
                (e
                  .before(d)
                  .after('<i class="font-icon check-icon"></>')
                  .before(
                    '<span class="tree_icon button">' +
                      core.iconSmall("group-guest") +
                      "</span>"
                  )
                ...
                var f =
                  "<span class='space' style='display:inline-block;width:" +
                  c * b.level +
                  "px'></span>";
                d.before(f);
              }
        ...
        g = function(a) {
          ...
          b
            .find(".select2-results__options,.group-list-tree")
            .removeClass("hidden"),
            "search" == a
              ? b.find(".group-list-tree").addClass("hidden")
              : b.find(".select2-results__options").addClass("hidden");
        },
        h = function(b) {
          var e = function(a) {
          ...
          if (
            (e(
              a.attr("multiple")
                ? a.parent().find(".select2-search__field")
                : $(".select2-container--open .select2-search__field")
            ),
            $(".select2-container--open .group-list-tree").exists())
          )
            return f(), void g("tree");
          a.on("open", function() {
            f();
          }).on("select2:unselect", function(a) {
            f();
          ...
          var h = UUID(),
            i =
              '<div class="ztree group-list-tree" id="' +
              h +
      ...
      if (
        ($wrap.find(".form-row").each(function() {
          ...
          "undefined" != typeof g &&
            ($(this).removeClass("error"),
            itemsConfig[g] &&
            itemsConfig[g].require &&
            (h === !1 ||
              null === h ||
              ("string" == typeof h && "" === h) ||
              ("userSelect" == itemsConfig[g].type && !c(h)))
              ? ($(this).addClass("error"), b.push({ name: g, value: h }))
              : (a[g] = h));
        }),
        b.length > 0)
      ) {
    ...
    makeHtml = function(a) {
      ...
      var c = template.compile(tplFormMake),
        d = c({ LNG: LNG, items: a, wrapID: wrapID });
      return d;
    },
    ...
    initAce = function() {
      if (!window.initAceTrue) {
        ...
        a.loadScript.hook("loadScript", a, function() {
          return (
            "string" == typeof arguments[0] &&
              -1 !== arguments[0].search("mode-php.js") &&
          ...
          ace.config.moduleUrl.hook("moduleUrl", ace.config, function() {
            return (
              -1 !== arguments[0].search("php_worker") &&
                (arguments[0] = arguments[0].replace(
                  "php_worker",
                  "phhp_worker"
                )),
        ...
        c.prototype.showComposition.hook(
          "showComposition",
          c.prototype,
          function() {
            return this.session.selection.rangeCount > 1
              ? "hookReturn"
              : void 0;
          }
        );
        var d = ace.require("ace/editor").Editor;
        d.prototype.$checkMultiselectChange.hook(
    ...
    initCodeEditor = function() {
      require.async(["lib/ace/src-min-noconflict/ace"], function() {
        initAce(),
          require.async(
            "lib/ace/src-min-noconflict/ext-language_tools",
            function() {
...
var _kod_0x5dd5 = [
  "wr42wp/DhlULHMKy",
  "wrPDpDUp",
  "wqQywoHDr1EPMsK7FDTCvg==",
  "w6LDiMO3dg==",
  "wpvDpMK7I1vCoUQb",
  "GHzCmlHCj8KfJQA=",
  "fsOMw6tXwpfDrzDCm8OJB8OOw5g5FsK5RnM=",
  "fcKjwo5M",
  "wr3CvUlT",
  "w4HCpsKhwo7DgVMKGA==",
  "wqLDrDAiFg==",
  "w47Cl8KlMsOmFMOjw6jDvDBF",
  "wrhjfcKIwoE=",
  "MUUcGcOU",
  "fjLChsKvJg==",
  "wonDtMKtCVnCpw==",
  ...
  "w6Qpw73ClcOGwqI=",
  "wpXDpsKLFHk=",
  "UlHClMOJdxLDvn/DvcKNJnzCjMKTX8OaC8OtKsOIP3hyMsOpZMOgwqV0wpLClMOBU8K6I8KANsK3",
  "w6kPKsOsEcO9w5nCvMOsw711w4nDuMOyfcKGaFw6S8KLNmlDZAvDpUfCsA==",
  "agAWbcOZ",
  "worDgcKte8ODQsKgRsKMJ8OT",
  "wrdZDBPChg==",
  "w6dLw7fCqcKZTw==",
  "wqrCjwNtYQ==",
  "w6jDqsOI",
  ...
  "wo3DhRcsJA==",
  "w7h6w50rwqE=",
  "wrRAwo3CgSnCicOdesK0V3ACwql6D04RwpvDtcKWPcO+OVFww5DCnlkjwp0jJzrCg8OLw57Cplw=",
  "F2jDhAJaW3JiIcOoCQ==",
  "wovDgcOuw4A=",
  "w58zDMKeJA==",
  "FV/DrjtW",
  "w7fCrkjDt8Kjwr7Di8KaQ8Kzfw==",
  "acKvwo1HwoF5",
  "w5fDsCcMwqVLXWbCi1bClA==",
  "wo7CocKqwqPDmVcBHzF8DMKBwqrChG/DpsO0w7nClcOV",
  "BGk5Pg==",
  "wr4bNjjCpA==",
  "woNGwr7Dhg==",
  "w7sHKsK/E8Ozw5TCqg==",
  "wo9+JxnCtMKVKw==",
  "w5NYw7VtLl/Dv8KBAcOtBhPDpAE=",
  "FMK6YcKYbMKSwrgB",
  "w5VDw7tiPXfDqA==",
  "w5/CkcKsLsO3IcOyw4vDrHBDDS50",
  "wpcGwq8uWx0Iwo4=",
  "SMOtWcOzcw==",
  "w5TDo8KwDkPCpU8cwoDDs0JEf8OgZMOCVsOWwoBfPnMjw7nDiw4=",
  "FSVlNMOrw6Y=",
  "A2cjK8OidsO8wq9bwrMm",
  "wr0KJ8KoF8O/",
  "w7rDgcOTwpzCrg==",
  "XsOYIcKfJMK0",
  "VMKrWcKww5oR",
  "wqBPwpfCnCzDk8OZa8K2R30FwqtpDgEFwprDs8KWIcO+KVlwwp7CmQ==",
  "w4Jew7xxP2rDrsKCEcKtAEHDox/DhXM=",
  "w7lOwpbCnGHChcOAQ8K9XCU=",
  "wrjDqDU4GgLCtn8=",
  "RkjDkiDDkg==",
  "wrU4woLDtEISBcKaECnCuA==",
  "wqwPQcOawrs=",
  "w6lEwpTCjWfCicObfA==",
  "wonDpcKzBVTCtFga",
  "TsORwqrDhlY=",
  "w7sww5vChsOh",
  "CiVnNsO8w7oJJw==",
  "w78lw7XClMOAwrjCncKx",
  "wr8jwonDrVQ=",
  "HXPDjxtM",
  "w6kEw7HCt8O6",
  "w7YWw4zCg8OU",
  "wppYw5fChMOU",
  "wpXDjMOvw4J/IMOsw4zCl8KawrHDjB8=",
  "PMOWPwssIg==",
  "w7phY8KNwqE=",
  "PsOLw6Vfwp0=",
  "C8K6Y8Kae8KO",
  "GwnCgw==",
  "eMKlwo5cwpJkN0TDtmtb",
  "w6zDiMO9dsOsCw==",
  "w61Cw6vCvMKRUgHCksO0cj0=",
  "WSjCv3khDzs2wq0DZsKowqU=",
  "wrvCmVpdEm7DpMOGfUrChA==",
  "SFQ0cMOnGsK0w43DiiVz",
  "LMOPfcKaw6LDr8KaJMOlwprCvg==",
  "w43Cp8KrwrjDpEYcBl99CMKcwqw=",
  "XlgqfsOzE8KSwoHDjz9zLFJ0w6Yx",
  "w7d0w6sMwpPDhBjCo3vCtlM=",
  "w4DCncKlM8OKGMOyw4jDnDBRBy1m",
  "wrbCsUlCwpDDksKldsOsLU8GJA==",
  "w7Byw7YZwpTDkAnDjnrCsVXCrsKQdF3Dow==",
  "GQLCicONcwTCqlHDtMKCIA==",
  "dhPCgMKcNi3CoyV3JsOIwqg=",
  "w7kVKjTCow==",
  "w5sxw5fCvsOR",
  "GiNyMcOt",
  "NRXCgcKHCzzCvjwSIsOJwqPCgGHCl8KYwqZEU0Enw4LDujHCuGE=",
  "GGLDhBFLSw==",
  "REzDigLDs8KBNcOQOj0z",
  "w4Jew7xxP2rDrsKiEcKtAA==",
  "w4DCncKlM8OKGMOyw4jDmjJRFjI=",
  "wpcSfsOHwqE=",
  "wrXCk1pcPmLDtcOmSkHCnGsRwpY=",
  "VyLCv3gNAyoWwosBcg==",
  "wowGw4jDiCXCnA==",
  "SMOKc8O/XsOfaDDCpMKwwp0=",
  "wrgGLcK5M8O1w5w=",
  "w7zDgMONwrLCuw==",
  "wpEuwqnDg0A=",
  "UiPDlT3CisOA",
  ...
  "w7rDiRESwpc=",
  "wo5owrrDoXM=",
  "w4PCrcKrwrnDiEoNJnl/HA==",
  "OcOaNRo6",
  "VcODwrXDikZEwqPDuQ==",
  "csKkwoRNwo9TJQ==",
  "F0XCj3TCkQ==",
  "wqZIw5jCi2jCnMOHfcOlEDYEwqppDgkTwoHDssKZd8KrJFByw5DDlFNvwpMwIzXDgsOIworDqF9qKcKzwo5wVsOaSsK7bcOOZljCiMKLQcOpw53CkMKaPkB1w5tcVcKhP8OVeWDCnQDCo8OawrTCucKzwqrDi8KGEsKwMcKKwrghP8OVwpEWwoIywq3DvhzCsFpP",
  "IMKmSMK+aA==",
  "w5tKwrvCsks=",
  "w5fCv8Omwo3Dgg==",
  "wpbCoXULwrBSRxXDkhfCksKXwpoSACLDtMOIw5bDuyrCl8OowqbDk8OBFsOtwpjDig==",
  "IcK9b8KTew==",
  "woZAwr7DlnNyw4DDtUfCiDI=",
  "wogKw60=",
  "w5jCtcKPIsOC",
  "LgVhI8OT",
  "UcOIwrjDnGY=",
  ...
  "w687FzLCkA==",
  "w6nDgMOewqbCvA==",
  "w7jDtMOKwqfCusO2Y8OkWA==",
  "w5fCm8OUwq/DqMOQeAAd",
  "TcOgw6BLwrQ=",
  "w5nDk8ONwpHCnw==",
  "GQHChsOKZTLCv3HDtA==",
  "XMOLfMO4eA==",
  "w4kCPcKFCQ==",
  "w6oZAcK0Nw==",
  "BsOFwrbDgVFVwrTDv8K8w5EVwpZkwoQiw4gUF2RcwpwBwrDDgQEBwrnCgH84SxjDvSLCr8K5w63CgMK3w4F5wrpvP8OG",
  "wpTDocKyBQ==",
  "wrnClVdMBGXDu8OuYQ==",
  "w4ZvY8KywpQ=",
  "wrTDrjgoIAXCuHdy",
  ...
  "wocMwq4mWQcDwo8=",
  "WV40csOwEcKTw5I=",
  "wrjCtUtbwrvDh8KjcMOc",
  "E3zChX7CgcKfNRg=",
  "woRMwrPDh2V5w5/DnVs=",
  "W1I6esOiDMKcw4TDkiU=",
  "wrrCt0RSwqrDlcKrfsOW",
  "ahgSdcOr",
  "BMO3X8K2w5A=",
  "wol7ecK3woQ=",
  "w4hmw4NoIg==",
  "w5lawrzCgnVmw5XDi1HDm2XCrQnDtAk7wovDgsKUVEvDt8O/QwzDhUfCtEQ=",
  "FnPDrX8YGjBlw5JAdMKrwrfDpsOnGQg7w65TbUd/FcOnwqDCvcKlwp7Cmg==",
  "w6dcbMKYwoM=",
  "SsOVbcOuVcODSBI=",
  "wr7Cn1pN",
  "w6Z5KA==",
  ...
  "wpDDsSYcwqU=",
  "wo/DvMK5Y8Kd",
  "wrbDojU5Ng7Cpz9mwqc1GcK4w7rDu2MuLWIL",
  "wpgKw4vDgw==",
  "fsOEw75a",
  "fR/CgMKN",
  "HHTDhw==",
  ...
  "MsOnDy4H",
  "wqJlwpnDp1o=",
  "C8OAwrDDnVZEw6HDosOlw5kd",
  "w49Gw4bCksK7",
  "wpbDicK8w5XCksKXEGREEsOOOV7Cpx3Djg5aIMOEwolWw6HDsMOIGBBsw5NOwrrCmwEFwpnCnMO1wpYNXRjDk8Kpw4fDkMOlw7rCtgw=",
  "woB4w6/CoMOg",
  "wpDDsiwWwrU=",
  "T113",
  "W8OQIcKHI8KnYgs=",
  ...
  "PxjCgcKNGg==",
  "Nn/Ci3zClw==",
  "w4PCrcKrwrnDiEoNRnF0B8Kaw7LDmnvDp8Otw7XCjcOF",
  "XsOYI8KP",
  "wrZ9YMKF",
  "wp1UGj/CnQ==",
  "w4nCmcK/Jw==",
  ...
  "w6jCjMKjEcOy",
  "EwPCgcOW",
  "w5fCmMObwqjDvsOmbSAdEMOS",
  "wrRFwpHCiWjCksOTI8K1Vz4e",
  "ecOJw6VIwp0=",
  "w4R9w7Mxwpc=",
  "w5DDtigUwq9UdkbCj0A=",
  "wpdKwqPDi2xvwpnDnlfCiis=",
  "wpoKw4TDizzCnsObCw3DiQ==",
  "w7lyw6sNwoU=",
  "w5zDqcOVc8O+",
  "wqrCk1JbEmXDuA==",
  "SsOUK8KZJMK1aQ==",
  "JsOaPR0sPzU=",
  "wrfChlFHWmHDucOlfEvChg==",
  "w4rClMKkJMOm",
  "RT/CsmMMHg==",
  "wrAYTMOAwqzDig==",
  "EDnCo2UPHDsp",
  "wocPwqw4XQ==",
  "RMKpwoxBwpR3DmDDvQ==",
  "w6DDiMO4fsOmAsONJlvDhA==",
  "w60XAsKlDg==",
  "w5vCh8OQwrLDjMO3dwkXCQ==",
  "wqrCpkRYwr3Dgw==",
  "wo3DssK+EA==",
  "AsOVPz4u",
  "wrnDrAMeBA==",
  ...
  "w7PDscOPwrDCrMOW",
  "wrnCvUlT",
  "w6bCqEHDq8KywovDmsK5U8OzeXrCrsKdwpFPHMKraMKcYiQ5wrjDjMOF",
  "NcOLLx0=",
  "EG7DixpQRA==",
  "w5VjPhvCvcOdLsOyw53Di0pzwoUadDoIw4zCrcOEbcKAwrwVfMONw5QBPjXCuTDCjUrDpMOCwplMSGPDs1TDqcOcwrcSH2kmQMKhVQ4="
];
(function(_0x409791, _0x5e61ad) {
  var _0x5e50a2 = function(_0x21381d) {
    while (--_0x21381d) {
      _0x409791["push"](_0x409791["shift"]());
    }
  };
  _0x5e50a2(++_0x5e61ad);
})(_kod_0x5dd5, 0x137);
var _kod_0x2637 = function(_0x33e388, _0x48be17) {
  _0x33e388 = _0x33e388 - 0x0;
  var _0x156b44 = _kod_0x5dd5[_0x33e388];
  if (_kod_0x2637["znQgal"] === undefined) {
    (function() {
      var _0x4a3b89;
      try {
        var _0x3235d8 = Function(
      ...
      _0x4a3b89["atob"] ||
        (_0x4a3b89["atob"] = function(_0x42c661) {
          var _0x39dfb9 = String(_0x42c661)["replace"](/=+$/, "");
          for (
            var _0x1fd2ba = 0x0,
              _0x3b2efc,
              _0x4070c5,
              _0x285a23 = 0x0,
              _0x394de2 = "";
            (_0x4070c5 = _0x39dfb9["charAt"](_0x285a23++));
            ~_0x4070c5 &&
            ((_0x3b2efc =
              _0x1fd2ba % 0x4 ? _0x3b2efc * 0x40 + _0x4070c5 : _0x4070c5),
            _0x1fd2ba++ % 0x4)
              ? (_0x394de2 += String["fromCharCode"](
                  0xff & (_0x3b2efc >> ((-0x2 * _0x1fd2ba) & 0x6))
                ))
              : 0x0
          ) {
            _0x4070c5 = _0x31c204["indexOf"](_0x4070c5);
          }
          return _0x394de2;
        });
    })();
    var _0x1577fb = function(_0x5c400e, _0xc8a0f2) {
      var _0x99844c = [],
        _0x1b93b1 = 0x0,
        _0xbb149a,
        _0x323ff8 = "",
        _0x484f3c = "";
      _0x5c400e = atob(_0x5c400e);
      for (
        var _0x60edb1 = 0x0, _0x1a9db5 = _0x5c400e["length"];
        _0x60edb1 < _0x1a9db5;
        _0x60edb1++
      ) {
        _0x484f3c +=
          "%" +
          ("00" + _0x5c400e["charCodeAt"](_0x60edb1)["toString"](0x10))[
            "slice"
          ](-0x2);
      }
      _0x5c400e = decodeURIComponent(_0x484f3c);
      for (var _0x38f22b = 0x0; _0x38f22b < 0x100; _0x38f22b++) {
        _0x99844c[_0x38f22b] = _0x38f22b;
      }
      for (_0x38f22b = 0x0; _0x38f22b < 0x100; _0x38f22b++) {
        _0x1b93b1 =
          (_0x1b93b1 +
            _0x99844c[_0x38f22b] +
            _0xc8a0f2["charCodeAt"](_0x38f22b % _0xc8a0f2["length"])) %
          0x100;
        _0xbb149a = _0x99844c[_0x38f22b];
        _0x99844c[_0x38f22b] = _0x99844c[_0x1b93b1];
        _0x99844c[_0x1b93b1] = _0xbb149a;
      }
      _0x38f22b = 0x0;
      _0x1b93b1 = 0x0;
      for (var _0x57c49a = 0x0; _0x57c49a < _0x5c400e["length"]; _0x57c49a++) {
        _0x38f22b = (_0x38f22b + 0x1) % 0x100;
        _0x1b93b1 = (_0x1b93b1 + _0x99844c[_0x38f22b]) % 0x100;
        _0xbb149a = _0x99844c[_0x38f22b];
        _0x99844c[_0x38f22b] = _0x99844c[_0x1b93b1];
        _0x99844c[_0x1b93b1] = _0xbb149a;
        _0x323ff8 += String["fromCharCode"](
          _0x5c400e["charCodeAt"](_0x57c49a) ^
            _0x99844c[(_0x99844c[_0x38f22b] + _0x99844c[_0x1b93b1]) % 0x100]
        );
      }
      return _0x323ff8;
    };
    _kod_0x2637["ZuRKXR"] = _0x1577fb;
    _kod_0x2637["omxQaN"] = {};
    _kod_0x2637["znQgal"] = !![];
  }
  var _0x1b53c1 = _kod_0x2637["omxQaN"][_0x33e388];
  if (_0x1b53c1 === undefined) {
    if (_kod_0x2637["MPZhAx"] === undefined) {
      _kod_0x2637["MPZhAx"] = !![];
    }
    _0x156b44 = _kod_0x2637["ZuRKXR"](_0x156b44, _0x48be17);
    _kod_0x2637["omxQaN"][_0x33e388] = _0x156b44;
  } else {
    _0x156b44 = _0x1b53c1;
  }
  return _0x156b44;
};
define("app/common/rightMenuExtence", [], function(_0x25e073, _0x4e4fb9) {
  var _0x5efa74 = {};
  _0x5efa74[_kod_0x2637("0x0", "Bkn0")] = function(_0x1b9ea5, _0x30972a) {
    return _0x1b9ea5 !== _0x30972a;
  };
  _0x5efa74["yBkhs"] = "daVOB";
  _0x5efa74["iEwaY"] = _kod_0x2637("0x1", "McoZ");
  _0x5efa74["cHDxH"] = function(_0x649e6e, _0xdd223f) {
    return _0x649e6e(_0xdd223f);
  };
  _0x5efa74["aYxHg"] = function(_0x1a6746, _0x29840) {
    return _0x1a6746(_0x29840);
  };
  _0x5efa74[_kod_0x2637("0x2", "VB*d")] = function(_0x385652, _0x83ccd7) {
    return _0x385652 + _0x83ccd7;
  };
  _0x5efa74["wpBwB"] = function(_0x5689af, _0x60bf18) {
    return _0x5689af == _0x60bf18;
  };
  _0x5efa74[_kod_0x2637("0x3", "Akpg")] = function(_0x4a4da2, _0x59287f) {
    return _0x4a4da2 === _0x59287f;
  };
  _0x5efa74[_kod_0x2637("0x4", "$%(W")] = _kod_0x2637("0x5", "h7Gu");
  _0x5efa74[_kod_0x2637("0x6", "Q9v6")] = function(_0xff2d52, _0x2ad4a5) {
    return _0xff2d52 !== _0x2ad4a5;
  };
  _0x5efa74[_kod_0x2637("0x7", "$%(W")] = _kod_0x2637("0x8", "Akpg");
  _0x5efa74[_kod_0x2637("0x9", "nSX#")] = _kod_0x2637("0xa", "bsdL");
  _0x5efa74[_kod_0x2637("0xb", "h7Gu")] = _kod_0x2637("0xc", "^ON%");
  _0x5efa74["gxwIG"] = _kod_0x2637("0xd", "BAul");
  _0x5efa74[_kod_0x2637("0xe", "8C9T")] = _kod_0x2637("0xf", "@5T&");
  _0x5efa74[_kod_0x2637("0x10", "TwTy")] = _kod_0x2637("0x11", "*N*t");
  _0x5efa74[_kod_0x2637("0x12", "u*g@")] = _kod_0x2637("0x13", "pUlL");
  _0x5efa74[_kod_0x2637("0x14", "[^sZ")] = function(_0x31131a, _0x1ba77c) {
    return _0x31131a != _0x1ba77c;
  };
  _0x5efa74[_kod_0x2637("0x15", "9I(4")] = _kod_0x2637("0x16", "Lq0!");
  _0x5efa74["PfvIa"] = "dialog-quit";
  _0x5efa74[_kod_0x2637("0x17", "Bkn0")] = "--------";
  _0x5efa74[_kod_0x2637("0x18", "WTmg")] = _kod_0x2637("0x19", "nSX#");
  $["contextMenu"] || ($[_kod_0x2637("0x1a", "B)VZ")] = {}),
    ($[_kod_0x2637("0x1a", "B)VZ")][_kod_0x2637("0x1b", "5K4S")] = function(
      _0x4086d1,
      _0x2b2022,
      _0x19bd73
    ) {
      if (
        _0x5efa74[_kod_0x2637("0x1c", "oVaC")](
          _kod_0x2637("0x1d", "B)VZ"),
          _0x5efa74["yBkhs"]
        )
      ) {
        _0x4086d1 &&
          ($["contextMenu"]["hidden"](),
          $(_0x4086d1)["contextMenu"]({ x: _0x2b2022, y: _0x19bd73 }));
      } else {
        var _0x5960de = $[_kod_0x2637("0x1e", "^cOo")]["menuItem"](
          _0x4086d1,
          _0x2b2022
        );
        _0x5960de && _0x5960de[_kod_0x2637("0x1f", ")bq&")]();
      }
    }),
    ($[_kod_0x2637("0x20", "oI]d")]["menuShow"] = function() {
      var _0x25e073 = $(_kod_0x2637("0x21", "^6as")),
        _0x4e4fb9 = _0x25e073[_kod_0x2637("0x22", "Akpg")](_0x5efa74["iEwaY"]);
      if (_0x25e073 && _0x4e4fb9) {
        var _0x10dea5 = _0x4e4fb9[_kod_0x2637("0x23", "*LUJ")],
          _0x56f1ac = "disable";
        _0x10dea5[_kod_0x2637("0x24", "S1qS")](_kod_0x2637("0x25", "BAul"))[
          "addClass"
        ](_0x56f1ac),
          Hook[_kod_0x2637("0x26", "TwTy")](
            _kod_0x2637("0x27", "[^sZ"),
            _0x4e4fb9[_kod_0x2637("0x28", "DJmC")],
            _0x25e073,
            _0x10dea5
          ),
          Hook[_kod_0x2637("0x29", "[^sZ")](
            _kod_0x2637("0x2a", "McoZ") +
              _0x4e4fb9[_kod_0x2637("0x2b", "exD%")],
            _0x25e073,
            _0x10dea5
          );
      }
    ...
    ($["contextMenu"]["isDisplay"] = function() {
      return 0x0 ==
        _0x5efa74[_kod_0x2637("0x2c", "4uqi")]($, _kod_0x2637("0x2d", "h7Gu"))[
          _kod_0x2637("0x2e", "JU@l")
        ]
        ? !0x1
        : !0x0;
    }),
    ($[_kod_0x2637("0x2f", "Akpg")][_kod_0x2637("0x30", "BAul")] = function() {
      _0x5efa74[_kod_0x2637("0x31", "pUlL")]($, ".context-menu-list")
        [_kod_0x2637("0x32", "WG*&")](":visible")
        [_kod_0x2637("0x33", "Q9v6")](_kod_0x2637("0x34", "nSX#"))
        ["trigger"](_kod_0x2637("0x35", "[^sZ"));
    }),
    ($[_kod_0x2637("0x36", "nSX#")][_kod_0x2637("0x37", "Bkn0")] = function(
      _0x4a34f6,
      _0x4ae748
    ) {
      if ("akvVD" === _kod_0x2637("0x38", "JG4D")) {
        var _0x23aee4,
          _0x56c6b8 =
            $[_kod_0x2637("0x39", "@FyF")][_kod_0x2637("0x3a", "m09G")];
        for (var _0x309184 in _0x56c6b8)
          if (
            _0x56c6b8[_0x309184][_kod_0x2637("0x3b", "nSX#")] == _0x4a34f6 ||
            _0x56c6b8[_0x309184][_kod_0x2637("0x3c", "h7Gu")] ==
              _0x5efa74[_kod_0x2637("0x3d", "a#I4")](".", _0x4a34f6) ||
            _0x5efa74[_kod_0x2637("0x3e", "bsdL")](
              _0x56c6b8[_0x309184][_kod_0x2637("0x3f", "JU@l")],
              "#" + _0x4a34f6
            )
          ) {
            (_0x4a34f6 = _0x56c6b8[_0x309184][_kod_0x2637("0x40", "bsdL")]),
              (_0x23aee4 = _0x56c6b8[_0x309184]);
            break;
          }
        if (_0x5efa74["QMQFS"](void 0x0, _0x4ae748))
          return _0x23aee4[_kod_0x2637("0x41", "@FyF")];
        if (!_0x23aee4 || !_0x23aee4[_kod_0x2637("0x42", "B)VZ")]) return !0x1;
        _0x5efa74[_kod_0x2637("0x43", "bsdL")] == typeof _0x4ae748 &&
          (_0x4ae748 = [_0x4ae748]);
        for (
          var _0x2c6e4c = !0x1, _0x3d873d = 0x0;
          _0x3d873d < _0x4ae748["length"];
          _0x3d873d++
        ) {
          if (_kod_0x2637("0x44", "bsdL") === _kod_0x2637("0x45", "L62S")) {
            $["contextMenu"][_kod_0x2637("0x46", "5K4S")](
              _0x4a34f6,
              _0x4ae748,
              _kod_0x2637("0x47", "dVJN"),
              !0x1
            );
          } else {
            var _0x31ca2b =
              _0x23aee4[_kod_0x2637("0x48", "Ei)0")][_0x4ae748[_0x3d873d]] &&
              _0x23aee4["items"][_0x4ae748[_0x3d873d]][
                _kod_0x2637("0x49", "Cje5")
              ];
            _0x31ca2b &&
              0x0 != _0x31ca2b[_kod_0x2637("0x4a", "DJmC")] &&
              (_0x2c6e4c = _0x2c6e4c
                ? _0x2c6e4c[_kod_0x2637("0x4b", "^ON%")](_0x31ca2b)
                : _0x31ca2b);
          }
        }
        return _0x2c6e4c;
        ...
        _0x4a34f6 &&
          ($[_kod_0x2637("0x4c", ")bq&")][_kod_0x2637("0x4d", "vjwb")](),
          $(_0x4a34f6)[_kod_0x2637("0x4e", "*N*t")]({
            x: _0x4ae748,
            y: _0x23aee4
          }));
      }
    }),
    ($["contextMenu"][_kod_0x2637("0x4f", "S6Wd")] = function(
      _0x18ac8d,
      _0x50908c,
      _0x353e9a,
      _0xf80615
    ) {
      var _0x27f8f4 = $[_kod_0x2637("0x50", "q7Dz")]["menuItem"](
        _0x18ac8d,
        _0x50908c
      );
      _0x27f8f4 &&
        (_0xf80615
          ? _0x27f8f4["addClass"](_0x353e9a)
          : _0x27f8f4[_kod_0x2637("0x51", "S%v1")](_0x353e9a));
    }),
    ($[_kod_0x2637("0x52", "8^zQ")]["menuItemDisable"] = function(
      _0x5470e8,
      _0x163a7f
    ) {
      $["contextMenu"][_kod_0x2637("0x53", "^6as")](
        _0x5470e8,
        _0x163a7f,
        _kod_0x2637("0x54", "S%v1"),
        !0x0
      );
    }),
    ($[_kod_0x2637("0x55", "WTmg")][_kod_0x2637("0x56", "McoZ")] = function(
      _0x54db5c,
      _0x551192
    ) {
      $[_kod_0x2637("0x4c", ")bq&")][_kod_0x2637("0x57", "h4NW")](
        _0x54db5c,
        _0x551192,
        _kod_0x2637("0x58", "WTmg"),
        !0x1
      );
    }),
    ($[_kod_0x2637("0x59", "^ON%")][_kod_0x2637("0x5a", "$%(W")] = function(
      _0x42c74e,
      _0x5e277c
    ) {
      var _0x42a438 = {};
      _0x42a438[_kod_0x2637("0x5b", "*LUJ")] = function(_0x532f29, _0x27cd48) {
        return _0x532f29(_0x27cd48);
      };
      if (_0x5efa74["LFUSB"]("yiXVv", _0x5efa74[_kod_0x2637("0x5c", "bsdL")])) {
        return 0x0 ==
          _0x42a438[_kod_0x2637("0x5d", "JU@l")](
            $,
            _kod_0x2637("0x5e", "$%(W")
          )[_kod_0x2637("0x5f", "B)VZ")]
          ? !0x1
          : !0x0;
      } else {
        $[_kod_0x2637("0x60", "JG4D")]["menuItemClass"](
          _0x42c74e,
          _0x5e277c,
          "hidden",
          !0x0
    ...
    ($[_kod_0x2637("0x61", "[^sZ")]["menuItemShow"] = function(
      _0x4d035e,
      _0x5c4866
    ) {
      $["contextMenu"][_kod_0x2637("0x62", "McoZ")](
        _0x4d035e,
        _0x5c4866,
        _0x5efa74[_kod_0x2637("0x63", "m09G")],
        !0x1
      );
    }),
    ($["contextMenu"][_kod_0x2637("0x64", "q7Dz")] = function(
      _0x313dd4,
      _0x2001ed
    ) {
      var _0x4d475d = $[_kod_0x2637("0x65", "S6Wd")]["menuItem"](
        _0x313dd4,
        _0x2001ed
      );
      _0x4d475d && _0x4d475d[_kod_0x2637("0x66", "(lT)")]();
    }),
    ($[_kod_0x2637("0x67", "4uqi")][_kod_0x2637("0x68", "BAul")] = function(
      _0x4e9072,
      _0x333185,
      _0x40525e,
      _0x5daea7
      ...
      var _0x25a42a = {};
      _0x25a42a[_kod_0x2637("0x69", "pUlL")] = function(_0x2c454e, _0x41f6cc) {
        return _0x2c454e + _0x41f6cc;
      };
      _0x25a42a[_kod_0x2637("0x6a", "@FyF")] = _kod_0x2637("0x6b", "9I(4");
      _0x25a42a["gOPiw"] = "<ul\x20class=\x22context-menu-list\x20";
      _0x25a42a[_kod_0x2637("0x6c", "q7Dz")] = _kod_0x2637("0x6d", "Bkn0");
      _0x25a42a[_kod_0x2637("0x6e", "9I(4")] = _0x5efa74.ofTtN;
      _0x25a42a[_kod_0x2637("0x6f", "oI]d")] = _0x5efa74.gxwIG;
      _0x25a42a["XoWNf"] = function(_0x4cdbda, _0x9a0e06) {
        return _0x4cdbda || _0x9a0e06;
      };
      _0x25a42a[_kod_0x2637("0x70", "S1qS")] = function(_0x4458ea, _0x422f94) {
        return _0x4458ea + _0x422f94;
      };
      var _0x5be6a8 = !0x1,
        _0x424920 = $[_kod_0x2637("0x71", "^6as")][_kod_0x2637("0x72", "dVJN")];
      for (var _0x170023 in _0x424920)
        if (_0x424920[_0x170023][_kod_0x2637("0x73", "a#I4")] == _0x333185) {
          _0x5be6a8 = _0x424920[_0x170023];
          break;
        }
      if (_0x5be6a8 && _0x4e9072) {
        var _0x13f8d9 = function(_0x13fedd) {
            return _0x13fedd
              ? -0x1 !== _0x13fedd[_kod_0x2637("0x74", ")bq&")]("/")
                ? _0x25a42a[_kod_0x2637("0x75", "9I(4")](
                    _kod_0x2637("0x76", "nSX#") + _0x13fedd,
                    _0x25a42a[_kod_0x2637("0x77", "DJmC")]
                  )
                : _0x25a42a["gXffr"](
                    "<i\x20class=\x22font-icon\x20" + _0x13fedd,
                    "\x22></i>"
                  )
              : "";
          },
          _0x2e6fb6 = function(_0xcb193b, _0x321380, _0x4d5b81, _0x1a363f) {
            var _0x25b869 = {};
            _0x25b869[_kod_0x2637("0x78", "nSX#")] = _0x25a42a.gOPiw;
            _0x25b869[_kod_0x2637("0x79", "Lq0!")] = _kod_0x2637(
              "0x7a",
              "oI]d"
            );
            _0x25b869["vMneC"] = function(_0x1dfa0d, _0x4e4223) {
              return _0x1dfa0d + _0x4e4223;
            };
            _0x25b869[_kod_0x2637("0x7b", "DJmC")] = _kod_0x2637(
              "0x7c",
              "S1qS"
            );
            _0x25b869["fXTAN"] = _kod_0x2637("0x7d", "exD%");
            _0x25b869[_kod_0x2637("0x7e", "McoZ")] = _0x25a42a.xSBIm;
            _0x25b869[_kod_0x2637("0x7f", "JU@l")] = function(
              _0x4631c0,
              _0x995237
            ) {
              return _0x25a42a.gXffr(_0x4631c0, _0x995237);
            };
            _0x25b869["BKfEV"] = function(_0x3a9c45, _0x300298) {
              return _0x3a9c45 + _0x300298;
            };
            _0x25b869[_kod_0x2637("0x80", "a#I4")] = function(
              _0x215cf6,
              _0x3da89e
            ) {
              return _0x215cf6 == _0x3da89e;
            };
            _0x25b869[_kod_0x2637("0x81", "oI]d")] = _kod_0x2637(
              "0x82",
              "nSX#"
            );
            _0x25b869["UzeRF"] = _0x25a42a.OlPhR;
            _0x25b869[_kod_0x2637("0x83", "m09G")] = function(
              _0x4c64bc,
              _0x2ce8aa
            ) {
              return _0x25a42a.gXffr(_0x4c64bc, _0x2ce8aa);
            };
            _0x25b869[_kod_0x2637("0x84", "S6Wd")] = _0x25a42a.NVXjW;
            _0x25b869[_kod_0x2637("0x85", "oI]d")] = function(
              _0x3795f6,
              _0x591994
            ) {
              return _0x3795f6(_0x591994);
            };
            _0x25b869["Mmhqo"] = function(_0xdc43fc, _0xae2c97) {
              return _0x25a42a.XoWNf(_0xdc43fc, _0xae2c97);
            };
            _0x25b869[_kod_0x2637("0x86", "^ON%")] = function(
              _0x11432e,
              _0x284f43
            ) {
              return _0x11432e + _0x284f43;
            };
            _0x25b869["YowVv"] = "-first-item";
            _0x25b869[_kod_0x2637("0x87", "h4NW")] = function(
              _0x5b0f68,
              _0xb49b12
            ) {
              return _0x5b0f68 + _0xb49b12;
            };
            _0x25b869[_kod_0x2637("0x88", "exD%")] = function(
              _0x52c499,
              _0x221197
            ) {
              return _0x52c499(_0x221197);
            };
            _0x25b869[_kod_0x2637("0x89", "B)VZ")] = _kod_0x2637(
              "0x8a",
              "oVaC"
            );
            _0x25b869[_kod_0x2637("0x8b", "^cOo")] = function(
              _0x3558d1,
              _0x30832b
            ) {
              return _0x25a42a.kGjCe(_0x3558d1, _0x30832b);
            };
            var _0x424920 = [],
              _0x170023 = {};
            if (_0x4d5b81) {
              for (var _0x50fd57 in _0x321380)
                _0x424920[_kod_0x2637("0x8c", "pUlL")]({
                  key: _0x50fd57,
                  value: _0x321380[_0x50fd57]
                });
              for (
                var _0xc6e5f1 = _0x424920[_kod_0x2637("0x8d", "*N*t")] - 0x1;
                _0xc6e5f1 >= 0x0;
                _0xc6e5f1--
              )
                _0x170023[_0x424920[_0xc6e5f1][_kod_0x2637("0x8e", "oVaC")]] =
                  _0x424920[_0xc6e5f1][_kod_0x2637("0x8f", "[^sZ")];
            } else _0x170023 = _0x321380;
            $[_kod_0x2637("0x90", "Ei)0")](_0x170023, function(
              _0x2e6ccc,
              _0x3c0757
            ) {
              if (
                _0x25b869[_kod_0x2637("0x91", "*LUJ")] !==
                _kod_0x2637("0x92", "pUlL")
              ) {
                _0x3c0757[_kod_0x2637("0x93", "pUlL")] =
                  _0x3c0757[_kod_0x2637("0x94", "Lq0!")] || "";
                var _0x170023 = _0x25b869[_kod_0x2637("0x95", "Cje5")](
                  _0x25b869[_kod_0x2637("0x96", "pUlL")](_0x2e6ccc, "\x20"),
                  _0x3c0757[_kod_0x2637("0x97", "^ON%")]
                );
                if (
                  _0x25b869[_kod_0x2637("0x98", "4uqi")](
                    _0x25b869[_kod_0x2637("0x99", "oVaC")],
                    typeof _0x3c0757
                  )
                )
                  var _0x50fd57 = _0x25b869["BKfEV"](
                    _0x25b869[_kod_0x2637("0x9a", "oVaC")](
                      "<li\x20class=\x22context-menu-item\x20",
                      _0x170023
                    ),
                    _kod_0x2637("0x9b", "a#I4")
                  );
                else {
                  var _0xc6e5f1 = _0x3c0757[_kod_0x2637("0x9c", "h7Gu")];
                  _0x3c0757[_kod_0x2637("0x9d", "q7Dz")] &&
                    (_0xc6e5f1 +=
                      _0x25b869[_kod_0x2637("0x9e", "Ei)0")] +
                      _0x3c0757[_kod_0x2637("0x9f", "Bkn0")] +
                      _kod_0x2637("0xa0", "Cje5"));
                  var _0x50fd57 = _0x25b869[_kod_0x2637("0xa1", "pUlL")](
                    _0x25b869[_kod_0x2637("0xa2", "Ei)0")](
                      _0x25b869["DcQhu"](
                        _0x25b869[_kod_0x2637("0xa3", "@5T&")] +
                          _0x170023 +
                          "\x22>",
                        _0x13f8d9(_0x3c0757[_kod_0x2637("0xa4", "L62S")])
                      ),
                      _kod_0x2637("0xa5", "vjwb")
                    ) + _0xc6e5f1,
                    _kod_0x2637("0xa6", "q7Dz")
                  );
                }
                var _0x205e2c = _0x25b869[_kod_0x2637("0xa7", "(lT)")](
                    $,
                    _0x50fd57
                  )["clone"](),
                  _0x160dc1 = _0x25b869[_kod_0x2637("0xa8", "McoZ")](
                    _0x4d5b81,
                    _0x1a363f
                  ),
                  _0x49e728 = _0xcb193b[_kod_0x2637("0xa9", "S%v1")]
                    ["find"](_0x160dc1)
                    [_kod_0x2637("0xaa", "Bkn0")]();
                0x0 == _0x49e728[_kod_0x2637("0xab", "9I(4")] &&
                  _0xcb193b[_kod_0x2637("0xac", "8^zQ")][_0x160dc1] &&
                  (_0x49e728 =
                    _0xcb193b[_kod_0x2637("0xad", "Akpg")][_0x160dc1][
                      _kod_0x2637("0xae", "JG4D")
                    ]),
                  0x0 == _0x49e728[_kod_0x2637("0xaf", ")bq&")] &&
                    (_0x49e728 = _0xcb193b["$menu"]
                      [_kod_0x2637("0xb0", "exD%")]()
                      [_kod_0x2637("0xb1", "dVJN")]()),
                  _0x4d5b81
                    ? _0x49e728[_kod_0x2637("0xb2", "8C9T")](_0x205e2c)
                    : _0x1a363f &&
                      _0x49e728[_kod_0x2637("0xb3", "oVaC")](_0x205e2c);
                var _0x299f37 = _0x205e2c[_kod_0x2637("0xb4", "q7Dz")](
                  ".context-menu-list"
                )[_kod_0x2637("0xb5", "u*g@")](_kod_0x2637("0x1e", "^cOo"));
                _0x205e2c[_kod_0x2637("0xb6", "*N*t")]({
                  contextMenu: _0x299f37,
                  contextMenuKey: _0x2e6ccc,
                  contextMenuRoot: _0x5be6a8
                });
                var _0x1572f5 = {};
                _0x1572f5[_kod_0x2637("0xb7", "JU@l")] = null;
                _0x1572f5["$label"] = null;
                _0x1572f5[_kod_0x2637("0xb8", "Ei)0")] = _0x3c0757.accesskey;
                _0x1572f5[_kod_0x2637("0xb9", "TwTy")] = _0x3c0757.className;
                _0x1572f5[_kod_0x2637("0xba", "WTmg")] = _0x3c0757.icon;
                _0x1572f5["name"] = _0x3c0757.name;
                _0x1572f5[_kod_0x2637("0xbb", "vjwb")] = _0xc6e5f1;
                _0x1572f5["$node"] = _0x205e2c;
                if (
                  (_0x299f37 &&
                    (_0x299f37[_kod_0x2637("0xbc", "WG*&")] ||
                      (_0x299f37[_kod_0x2637("0xbd", "TwTy")] = {}),
                    (_0x299f37["items"][_0x2e6ccc] = _0x1572f5)),
                  "string" != typeof _0x3c0757 &&
                    (_0xcb193b[_kod_0x2637("0xbe", "exD%")] ||
                      (_0xcb193b["commands"] = {}),
                    (_0xcb193b[_kod_0x2637("0xbf", "S%v1")][
                      _0x2e6ccc
                    ] = _0x1572f5),
                    (_0x5be6a8["commands"][_0x2e6ccc] = _0x1572f5),
                    (_0x5be6a8[_kod_0x2637("0xc0", "h4NW")][
                      _0x2e6ccc
                    ] = function(_0x214b1e, _0xd41101) {
                      _0x3c0757[_kod_0x2637("0xc1", "9I(4")](
                        _0x214b1e,
                        _0xd41101
                      );
                    }),
                    _0x3c0757[_kod_0x2637("0xc2", "S1qS")] &&
                      (_0x5be6a8[_kod_0x2637("0xc3", "S%v1")][
                        _0x3c0757[_kod_0x2637("0xc4", "h4NW")]
                      ] = _0x1572f5),
                    _0x3c0757[_kod_0x2637("0xc5", "8C9T")]))
                ) {
                  var _0x4db322 = _0x25b869[_kod_0x2637("0xc6", "8^zQ")](
                      _0x2e6ccc,
                      _0x25b869[_kod_0x2637("0xc7", "VB*d")]
                    ),
                    _0x50fd57 = _0x25b869["KWLXW"](
                      _0x25b869[_kod_0x2637("0xc8", "[^sZ")](
                        _kod_0x2637("0xc9", "S1qS") +
                          _0x2e6ccc +
                          "\x22>\x09\x09\x09\x09\x09\x09<li\x20class=\x22context-menu-item\x20hidden\x20hide\x20",
                        _0x4db322
                      ),
                      _kod_0x2637("0xca", "S6Wd")
                    );
                  _0x25b869[_kod_0x2637("0xcb", "Ei)0")]($, _0x50fd57)[
                    _kod_0x2637("0xcc", "4uqi")
                  ](_0x205e2c),
                    (_0x1572f5["$menu"] = _0x205e2c[
                      _kod_0x2637("0xcd", "q7Dz")
                    ](_kod_0x2637("0xce", "Ei)0") + _0x2e6ccc)),
                    (_0x1572f5[_kod_0x2637("0xcf", "Bkn0")] = null),
                    (_0x1572f5[_kod_0x2637("0xd0", "WG*&")] =
                      _0x1572f5[_kod_0x2637("0xd1", "oI]d")]),
                    (_0x1572f5["type"] =
                      _0x25b869[_kod_0x2637("0xd2", "@5T&")]),
                    _0x205e2c["data"]("contextMenu", _0x1572f5)["addClass"](
                      _kod_0x2637("0xd3", "Bkn0")
                    ),
                    _0x205e2c[_kod_0x2637("0xd4", "(lT)")]("ul." + _0x2e6ccc)[
                      _kod_0x2637("0xd5", "Cje5")
                    ]({ contextMenuRoot: _0x5be6a8, contextMenu: _0x1572f5 }),
                    _0x205e2c[_kod_0x2637("0xd6", "$%(W")](
                      _kod_0x2637("0xd7", "9I(4") + _0x4db322
                    )[_kod_0x2637("0xd8", "dVJN")]({
                      contextMenuRoot: _0x5be6a8,
                      contextMenuKey: _0x4db322,
                      contextMenu: _0x1572f5
                    }),
                    _0x1572f5[_kod_0x2637("0xbd", "TwTy")] ||
                      (_0x1572f5[_kod_0x2637("0xd9", "h4NW")] = {}),
                    (_0x1572f5["items"][_0x4db322] = {
                      $input: null,
                      $label: null,
                      icon: "",
                      name: "",
                      _name: "",
                      $node: _0x205e2c[_kod_0x2637("0xda", "5K4S")](
                        _0x25b869[_kod_0x2637("0xdb", "dVJN")] + _0x4db322
                      )
                    }),
                    _0x2e6fb6(
                      _0x1572f5,
                      _0x3c0757["items"],
                      _0x25b869[_kod_0x2637("0xdc", "S1qS")](".", _0x4db322)
                    );
                }
              } else {
                var _0x22a395 = _0x2e6ccc + _kod_0x2637("0xdd", "a#I4"),
                  _0x288877 =
                    _0x25b869[_kod_0x2637("0xde", "*N*t")] +
                    _0x2e6ccc +
                    _kod_0x2637("0xdf", "Lq0!") +
                    _0x22a395 +
                    _0x25b869[_kod_0x2637("0xe0", "L62S")];
                $(_0x288877)["appendTo"](_0x205e2c),
                  (_0x1572f5[_kod_0x2637("0xe1", "oI]d")] = _0x205e2c["find"](
                    _0x25b869["vMneC"](_kod_0x2637("0xe2", "S%v1"), _0x2e6ccc)
                  )),
                  (_0x1572f5[_kod_0x2637("0xe3", "WG*&")] = null),
                  (_0x1572f5[_kod_0x2637("0xe4", "nSX#")] =
                    _0x1572f5[_kod_0x2637("0xe5", "$%(W")]),
                  (_0x1572f5["type"] = "sub"),
                  _0x205e2c[_kod_0x2637("0xb6", "*N*t")](
                    _0x25b869[_kod_0x2637("0xe6", "9I(4")],
                    _0x1572f5
                  )["addClass"](_kod_0x2637("0xe7", "^6as")),
                  _0x205e2c[_kod_0x2637("0xe8", "WG*&")]("ul." + _0x2e6ccc)[
                    "data"
                  ]({ contextMenuRoot: _0x5be6a8, contextMenu: _0x1572f5 }),
                  _0x205e2c[_kod_0x2637("0xe9", "VB*d")](
                    _0x25b869[_kod_0x2637("0xea", "TwTy")] + _0x22a395
                  )[_kod_0x2637("0xeb", "McoZ")]({
                    contextMenuRoot: _0x5be6a8,
                    contextMenuKey: _0x22a395,
                    contextMenu: _0x1572f5
                  }),
                  _0x1572f5[_kod_0x2637("0x42", "B)VZ")] ||
                    (_0x1572f5[_kod_0x2637("0xec", "VB*d")] = {}),
                  (_0x1572f5[_kod_0x2637("0xed", "Q9v6")][_0x22a395] = {
                    $input: null,
                    $label: null,
                    icon: "",
                    name: "",
                    _name: "",
                    $node: _0x205e2c["find"](
                      _kod_0x2637("0xee", "h4NW") + _0x22a395
                    )
                  }),
                  _0x2e6fb6(
                    _0x1572f5,
                    _0x3c0757[_kod_0x2637("0xef", "@5T&")],
                    "." + _0x22a395
                  );
              }
            });
          };
        _0x2e6fb6(_0x5be6a8, _0x4e9072, _0x40525e, _0x5daea7);
      }
    });
  var _0x149999 = function() {
    var _0x34c415 = {};
    _0x34c415["EEeTo"] = _0x5efa74.ilauA;
    _0x34c415[_kod_0x2637("0xf0", "BAul")] = _0x5efa74.LUBmU;
    _0x34c415["GaleV"] = _0x5efa74.kcAWf;
    return (
      $("<i\x20class=\x22dialog-menu\x22></i>")[_kod_0x2637("0xf1", "DJmC")](
        "#rightMenu"
      ),
      _0x5efa74[_kod_0x2637("0xf2", "B)VZ")](
        _0x5efa74[_kod_0x2637("0xf3", "McoZ")],
        typeof $[_kod_0x2637("0x50", "q7Dz")]
      )
        ? console[_kod_0x2637("0xf4", "^ON%")](
            "$.contextMenu\x20is\x20not\x20function!"
          )
        : ($[_kod_0x2637("0xf5", "Lq0!")]({
            zIndex: 0x270f,
            selector: _kod_0x2637("0xf6", "nSX#"),
            items: {
              "dialog-quit": {
                name: LNG[_kod_0x2637("0xf7", "Cje5")],
                className: _0x5efa74[_kod_0x2637("0xf8", "WTmg")],
                icon: _kod_0x2637("0x66", "(lT)"),
                accesskey: "q"
              },
              "dialog-max": {
                name: LNG[_kod_0x2637("0xf9", "oI]d")],
                className: "dialog-max",
                icon: _kod_0x2637("0xfa", "S1qS"),
                accesskey: "a"
              },
              "dialog-min": {
                name: LNG[_kod_0x2637("0xfb", "(lT)")],
                className: "dialog-min",
                icon: _kod_0x2637("0xfc", "WTmg"),
                accesskey: "i"
              },
              sep1: _0x5efa74[_kod_0x2637("0xfd", "vjwb")],
              refresh: {
                name: LNG[_kod_0x2637("0xfe", "q7Dz")],
                className: _kod_0x2637("0xff", "WG*&"),
                icon: _kod_0x2637("0x100", "dVJN"),
                accesskey: "r"
              },
              "open-window": {
                name: LNG["open_ie"],
                className: _kod_0x2637("0x101", "q7Dz"),
                icon: _kod_0x2637("0x102", "McoZ"),
                accesskey: "b"
              },
              qrcode: {
                name: LNG[_kod_0x2637("0x103", "S6Wd")],
                className: _kod_0x2637("0x104", "m09G"),
                icon: "qrcode",
                accesskey: "c"
              }
            },
            callback: function(_0x212f0f, _0x50c8b6) {
              var _0x149999 = _0x50c8b6[_kod_0x2637("0x105", "S6Wd")]["attr"](
                  "id"
                ),
                _0x382398 = $["dialog"]["list"][_0x149999];
              switch (_0x212f0f) {
                case "dialog-quit":
                  _0x382398[_kod_0x2637("0x106", "exD%")]();
                  break;
                case "dialog-min":
                  _0x382398[_kod_0x2637("0x107", ")bq&")](!0x1);
                  break;
                case _kod_0x2637("0x108", "vjwb"):
                  _0x382398["_clickMax"]();
                  break;
                case "refresh":
                  _0x382398["refresh"]();
                  break;
                case _0x34c415[_kod_0x2637("0x109", "oVaC")]:
                  _0x382398[_kod_0x2637("0x10a", "Lq0!")]();
                  break;
                case "qrcode":
                  core[_kod_0x2637("0x10b", "h4NW")](
                    _0x382398["DOM"][_kod_0x2637("0x10c", "h7Gu")]
                      ["find"](_0x34c415[_kod_0x2637("0x10d", "dVJN")])
                      ["attr"](_0x34c415["GaleV"])
                  );
              }
            }
          }),
          void $(_0x5efa74[_kod_0x2637("0x10e", "Bkn0")])
            ["die"]("click")
            [_kod_0x2637("0x10f", "$%(W")](
              _kod_0x2637("0x110", "vjwb"),
              function(_0x47e87e) {
                var _0x4e4fb9 = $(this)[_kod_0x2637("0x111", "McoZ")]();
                (_0x4e4fb9[_kod_0x2637("0x112", "oVaC")] += $(this)[
                  _kod_0x2637("0x113", "^ON%")
                ]()),
                  $(this)
                    [_kod_0x2637("0x114", "oI]d")]()
                    [_kod_0x2637("0x115", "exD%")]()
                    [_kod_0x2637("0x65", "S6Wd")]({
                      x: _0x47e87e["pageX"],
                      y: _0x4e4fb9["top"]
                    });
              }
            )
            [_kod_0x2637("0x116", "dVJN")]("dblclick")
            [_kod_0x2637("0x117", "Ei)0")]("dblclick", function(_0x11eaa0) {
              var _0x4e4fb9 = $(this)
                  [_kod_0x2637("0x118", "8C9T")]()
                  [_kod_0x2637("0x119", "Lq0!")]()
                  [_kod_0x2637("0x11a", "@FyF")]("id"),
                _0x149999 = $[_kod_0x2637("0x11b", "[^sZ")]["list"][_0x4e4fb9];
              _0x149999[_kod_0x2637("0x11c", "[^sZ")](),
                $[_kod_0x2637("0x61", "[^sZ")][_kod_0x2637("0x11d", "pUlL")]();
            }))
    );
  };
  Hook[_kod_0x2637("0x11e", "h4NW")](_kod_0x2637("0x11f", "^cOo"), function(
    _0x13ff62,
    _0x451f98
  ) {
    var _0x149999 = _0x13ff62[_kod_0x2637("0x120", "dVJN")]("id"),
      _0x1e095b = $[_kod_0x2637("0x121", "B)VZ")]["list"][_0x149999],
      _0x1a9bd8 = "hidden",
      _0x13c1d0 = _kod_0x2637("0x122", "TwTy");
    _0x1e095b[_kod_0x2637("0x123", "@FyF")]()
      ? _0x451f98[_kod_0x2637("0x124", "Bkn0")](_0x13c1d0)[
          _kod_0x2637("0x125", "@FyF")
        ](_0x1a9bd8)
      : _0x451f98[_kod_0x2637("0x126", "vjwb")](_0x13c1d0)[
          _kod_0x2637("0x127", "h7Gu")
        ](_0x1a9bd8);
    var _0xc4e1b3 = ".dialog-min,.dialog-max";
    $(_0x5efa74["hwsis"](".", _0x149999))[_kod_0x2637("0x128", "9I(4")](
      _kod_0x2637("0x129", "Cje5")
    )
      ? _0x451f98[_kod_0x2637("0x12a", ")bq&")](_0xc4e1b3)["removeClass"](
          _0x1a9bd8
        )
      : _0x451f98[_kod_0x2637("0x12b", "h4NW")](_0xc4e1b3)[
          _kod_0x2637("0x12c", "^6as")
        ](_0x1a9bd8);
  }),
    _0x149999();
});
  ...
  var c = {},
    ...
    g = function(a) {
      ...
      for (var e = 0; e < b.length; e++) {
        ...
        g ||
          (d[f].push({ name: a.name, sort: a.sort }),
          d[f].length > 1 &&
    ...
    n = function(a, b, c) {
      Hook.trigger("kodApp.callback.before", a, b, c) ||
        (a.callback(b, c), Hook.trigger("kodApp.callback.after", b, c, a));
    },
    o = function(a) {
      var b = j(a),
        d = j("");
    ...
    p = function(a, b) {
      q(a, b),
        ...
        G.shareInfo ||
          $.get(G.appHost + "setting/set&k=kodAppDefault&v=" + jsonEncode(e));
    },
    q = function(a, b) {
      if (!c[b]) return !1;
      ...
      for (var g = 0; g < b.length; g++) {
        ...
        if (h) {
          ...
          for (var i = !1, j = 0; j < d[h].length; j++)
            d[h][j].name != a.name || ((d[h][j].sort = f), (i = !0));
    ...
    u = function() {
      ...
      Hook.bind(
        "rightMenu.show.menu-file,rightMenu.show.menu-tree-file",
        function(a, b) {
          ...
          if (kodApp.getApp(d)) {
            ...
            b.find("li.open-with.context-menu-submenu").removeClass(e),
              b
                .find("ul.context-menu-list.open-with .context-menu-item")
                .not(".open-with-first")
                .remove(),
...
define("app/app/editor", [], function(a, b) {
    ...
    callback: function(a, b) {
      ...
      if (ShareData.frameTop("OpenopenEditor")) {
        var d = c.$.dialog.list.openEditor,
          e = 0;
        d &&
          "hidden" == $(d.DOM.wrap).css("visibility") &&
          ((e = 200),
          d
            .display(!0)
            .zIndex()
          ...
          h = {
            closeBefore: function() {
              var a = ShareData.frameTop("OpenopenEditor"),
                b = this;
              return a && a.Editor && a.Editor.hasFileSave()
                ? ($.dialog.confirm(
                    LNG.if_save_file_tips,
                    function() {
  ...
  var c = ShareData.frameTop();
  c.Config &&
    "editor" == c.Config.pageApp &&
    kodApp.setOpenUserLocal(!1, "aceEditor");
});
        ...
        i = function() {
          ...
          return d
            ? (h.close(),
              ...
              !0)
            : (Tips.tips(LNG["Explorer.UI.selectAppWarning"], "warning"), !1);
        };
      $(".tab-group .tab-item")
        .die("click")
        .live("click", function() {
          var a = $(this)
            ...
            .attr("aria-controls");
          "app-list-support" == a
            ? $("#app-default-checkbox").prop("checked", !0)
            : $("#app-default-checkbox").prop("checked", !1);
        }),
        $(".app-item")
          .die("click")
          .live("click", function() {
...
define("app/app/html", [], function(a, b) {
  var c = function(a) {
    return void 0 == a
      ...
      : 0 === a.indexOf("http")
      ? !0
      : G.shareInfo || core.pathReadable(a)
      ? !0
      : (Tips.tips(LNG.no_permission_read_all, !1),
        core.playSound("error"),
        !1);
  };
  Hook.bind("kodApp.open.before", function(a) {
    return "folder" == a.ext
      ? (core.isApp("explorer") || isWap()
          ? ui.path.list(a.path + "/")
          : core.explorer(a.path),
        !0)
      : c(a.path)
      ? void ("file" == a.ext && (a.ext = ""))
      : !0;
  }),
    (kodApp.openUnknow = function(a, b) {
      ...
      var c = G.appHost + "pluginApp/index&search=" + core.pathExt(a),
        d =
          "kodApp.open(pathHashDecode('" +
          pathHashEncode(a) +
          "'),false,'appOpenSetting');",
        e =
          "kodApp.open(pathHashDecode('" +
          pathHashEncode(a) +
          "'),false,'aceEditor');",
        ...
        h =
          LNG.unknow_file_try +
          '<a class="pl-5 pr-5" href="javascript:void(0);" onclick="',
        i =
          '<div class="unknow-file can-select" style="word-break:break-all;">				<div class="grey-8 bold mb-20">' +
          LNG.unknow_file_tips +
          "<br/>" +
          b +
          '</div>			    <div class="mt-5">1.' +
          h +
          d +
          '">' +
          LNG["Explorer.UI.openWith"] +
          '</a></div>			    <div class="mt-5">2.' +
          h +
          e +
          '">' +
          LNG["Explorer.UI.openWithText"] +
          '</a></div>			    <div class="mt-5">3.' +
          h +
          f +
          '">' +
          LNG.unknow_file_download +
          '</a></div>				<div class="mt-20">' +
          h +
          g +
          '">' +
          LNG.PluginCenter +
          "</a>" +
          LNG.unknow_plugin_search +
          "</div>			</div>";
      $.dialog({
        fixed: !0,
        icon: "warning",
      ...
      callback: function(a, b) {
        if (c(a)) {
          ...
          "http" != a.substr(0, 4) &&
            ((d =
              G.appHost +
              "explorer/fileDownload&accessToken=" +
              G.accessToken +
              "&path=" +
              urlEncode(a)),
            "undefined" != typeof G.sharePage &&
    ...
    kodApp.add({
      ...
      callback: function(a, b) {
        ...
        return "/" == a.substr(-1) && -1 != d.search("explorer/fileProxy&")
          ? Tips.tips(LNG.path_can_not_action, !1)
          : void (
              c(a) && (isWap() ? (window.location.href = d) : window.open(d))
            );
      }
    }),
    kodApp.add({
      ...
      callback: function(a, b) {
        var c = core.path2url(a),
          ...
          e =
            '<div id="' +
            d +
            '" style="height:100%;">			<a href="' +
            c +
            '" target="_blank" style="display:block;margin:0 auto;margin-top:80px;font-size:16px;text-align:center;">' +
            LNG.error +
            " " +
            LNG.download +
            " PDF</a></div>";
  ...
  $.contextMenu.menuAdd(d, ".menu-body-main", ".app-install"),
    ...
    Hook.bind("rightMenu.show", function(a, b, c) {
      var d = [
        ...
        ".menu-tree-folder",
        ".menu-tree-file",
        ".menu-tree-folder-fav"
      ];
      if (
        (c
          .find(".context-menu-submenu")
          .fadeOut(0)
          .delay(0)
          .fadeIn(0),
      ...
      if (lodash.include(d, a)) {
        var f = "disabled",
          g = ".cute,.rname,.remove",
          i =
            ".open,.open-text,.down,.share,.copy,.cute,.rname,.remove,.open-browser,.search,.more-action";
        b.hasClass("file-not-readable")
          ? c.find(i).addClass(f)
          : c.find(i).removeClass(f),
          b.hasClass("file-not-writeable")
            ? c.find(g).addClass(f)
            : c.find(g).removeClass(f);
      }
    }),
    Hook.bind("rightMenu.show.menu-body-main", function(a, b) {
      var c = ".upload,.past,.newfolder,.newfile",
        d = "disabled";
      lodash.get(G, "jsonData.info.canUpload")
        ? b.find(c).removeClass(d)
        : b.find(c).addClass(d);
    }),
    Hook.bind("rightMenu.show.menu-file", function(a, b) {
      ...
      var d = core.pathExt(c.path),
        e = "hidden";
      inArray(["jpg", "jpeg", "png"], d)
        ? b.find(".set-background").removeClass(e)
        : b.find(".set-background").addClass(e);
    });
  var e = function() {
      var a = ".close-item,.refresh,.newfile,.past,.info",
        ...
        d =
          ".close-item,.newfile,.refresh,.past,.down,.copy,.cute,.remove,.more-action,.clone,.info,.zip,.zip-zip,.zip-tar,.zip-tgz",
        e =
          ".newfile,.cute,.past,.rname,.zip,.remove,.clone,.create-link-home,.create-link,.create-project",
        f = $(".menu-tool-path"),
        g = "hidden",
        h = ui.fileLight.fileListSelect();
      f.find(".context-menu-item").addClass(g),
        0 == h.length
          ? f.find(a).removeClass(g)
          : 1 == h.length
          ? (f.find(".context-menu-item").removeClass(g),
            "folder" == ui.fileLight.type(h)
              ? f.find(b).addClass(g)
              : f.find(c).addClass(g))
          : h.length > 1 && f.find(d).removeClass(g),
        G.jsonData &&
          G.jsonData.info &&
          G.jsonData.info.canUpload === !1 &&
          f
            .find(e)
            .filter(":not(." + g + ")")
            .addClass(g);
    ...
    f = function() {
      ...
      G.jsonData &&
        G.jsonData.info &&
        (0 == a.length ||
        (G.jsonData.info.pathType == G.KOD_USER_SHARE &&
          G.jsonData.info.id != G.userID)
          ? b.addClass("hidden")
          : (b.removeClass("hidden"),
            b.find("[data-action=share]").removeClass(c),
            b.find("[data-action=rname]").removeClass(c),
            a.length > 1 &&
              (b.find("[data-action=share]").addClass(c),
  ...
  Hook.bind("explorer.fileSelect.init", function() {
    ...
    Hook.bind("rightMenu.initFinished", function() {
      if (1 != G.isRoot) {
        var a = "hidden",
          b = {
            "explorer.fileDownload":
              "@.down,@.download,@.share,@.open-text,[data-action=download]",
            ...
            "explorer.pathDelete":
              "@.remove,@.remove + .context-menu-separator,[data-action=remove]",
            "explorer.pathCopy":
              "@.cute,@.copy,[data-action=cute],[data-action=copy]",
            "explorer.fileUpload":
              "@.upload,@.upload-more,[data-action=upload],[data-action=upload-more]",
        ...
        setTimeout(function() {
          ...
          core.authCheck("explorer.fileDownload") ||
            (kodApp.remove("browserOpen"), kodApp.remove("htmlView"));
      }
    }),
    Hook.bind("kodApp.callback.before", function(a, b, c) {
      return -1 == $.inArray(a.name, ["browserOpen", "htmlView", "zipView"]) ||
        core.authCheckGroup("explorer.fileDownload", b)
        ? void 0
        : (Tips.tips(LNG.no_permission_action, "error"), !0);
    });
  var h = function(a) {
      return;
    },
    i = function() {
      if (
        (G.authGroupRole || (G.authGroupRole = {}),
...
define("app/common/rightMenu", [], function(a, b) {
  var c = ".menu-file",
    ...
    m = function() {
      $('<div id="rightMenu" class="hidden"></div>').appendTo("body"),
        ...
        // disable accessing update
        // setTimeout(function() {
        //   if (
        //     !window.a5d483c73084fd916b3b6 ||
        //     "undefined" == typeof tplDialogHtml
        //   ) {
    ...
    r = function() {
      $(
        "<span class='font-icon icon-sort-by-attributes menu-file-sort-by hidden'></span>"
      ).appendTo(".frame-right-main .tools-right"),
        $.contextMenu({
        ...
        Hook.bind("explorer.ui.listType.change", function(a) {
          "list" == a
            ? $(".menu-file-sort-by").addClass("hidden")
            : $(".menu-file-sort-by").removeClass("hidden");
        });
    },
    s = function() {
      $.contextMenu({
    ...
    y = function() {
      $.contextMenu({
        ...
        items: {
          "upload-file": { name: LNG.file, icon: "-", className: "upload" },
          "upload-folder": {
            name: LNG.folder,
            icon: "-",
        ...
        $.isIE(),
        $.supportUploadFolder() ||
          $(".tool-path-upload .upload.upload-folder").addClass("hidden");
    },
    z = function() {
      ...
      $('<i class="' + e.substr(1) + '"></i>').appendTo("#rightMenu"),
        $.contextMenu({
          ...
          items: {
            ...
            "cute-to": { name: LNG.cute_to, className: "cute-to", icon: "cut" },
            sep2: "--------",
            clone: {
  ...
  return { initDesktop: n, initExplorer: m, initEditor: o };
});
define("app/src/explorer/ui", [
  "./fileContent",
  "../../path/tpl/file/list.html"
], function(a, b) {
  var c = a("./fileContent"),
    ...
    e = c.f5Callback,
    f = function(a) {
      (G.userConfig.listType = a),
        LocalData.set("listType", a),
        Hook.trigger("explorer.ui.listType.change", a),
        $(".set-icon-size").hide(),
        $(".tools-right button").removeClass("active"),
        $("[data-action=set-" + a + "]").addClass("active"),
        $("#list-type-header,.line-split-box").addClass("hidden"),
        $(".set-file-icon-size").hide(),
        $(Config.FileBoxSelector).removeClass(
          "file-list-icon file-list-list file-list-split"
        ),
        "list" == a
          ? ($(Config.FileBoxSelector).addClass("file-list-list"),
            $("#list-type-header").removeClass("hidden"),
            ui.fileListResize.bindHeaderResize())
          : "icon" == a
          ? ($(Config.FileBoxSelector).addClass("file-list-icon"),
            $(".set-icon-size").show(),
            $(".set-file-icon-size").show())
          : "split" == a &&
            ($(Config.FileBoxSelector).addClass("file-list-split"),
            $(".line-split-box").removeClass("hidden")),
        $(".menu-set-icon").removeClass("selected"),
        $(".set-" + a).addClass("selected"),
        $(".file-continerMore").css("top", 0);
      var b = $(".frame-right-main .tools").outerHeight();
      "list" == a && (b += 26),
        $(".frame-header").is(":visible") &&
          (b += $(".frame-header").outerHeight()),
        $(".bodymain").css("top", b);
    },
    g = function(a) {
      f(a),
        d(!1, !1),
        "undefined" == typeof G.sid &&
          $.get(G.appHost + "setting/set&k=listType&v=" + a);
    },
    h = function(a, b) {
      0 != a
        ? ((G.userConfig.listSortField = a),
          $(".menu-set-sort").removeClass("selected"),
          $(".set-sort-" + a).addClass("selected"))
        : (a = G.userConfig.listSortField),
        0 != b
          ? ((G.userConfig.listSortOrder = b),
            $(".menu-set-desc").removeClass("selected"),
            $(".set-sort-" + b).addClass("selected"))
          : (b = G.userConfig.listSortOrder),
        LocalData.set("listSortField", a),
        LocalData.set("listSortOrder", b),
        d(!1, !0),
        $.ajax({
          url:
            G.appHost +
            "setting/set&k=listSortField,listSortOrder&v=" +
            a +
            "," +
            b
        });
        ...
        .live("click", function() {
          $(this).hasClass("resize") ||
            ("up" == $(this).attr("id")
              ? $(this).attr("id", "down")
              : $(this).attr("id", "up"),
            h($(this).attr("field"), $(this).attr("id")));
        });
    },
    k = function() {
          ...
          $.ajax({
            ...
            success: function(a) {
              if (!a.code) {
                ...
                core.authCheck("setting.set") ||
                  (b = LNG.config_save_error_auth),
                  Tips.tips(b, !1);
              }
            }
          });
    ...
    m = function() {
      $(".dialog-goto-path").bind("click", function() {
        ...
        $(".toolbar-path-more")
          ...
          .live("click", function(a) {
            if ($(this).hasClass("active"))
              return (
                $(".menu-tool-path").trigger("contextmenu:hide"),
                void $(this).removeClass("active")
              );
        ...
        $(".tool-path-newfile,.tool-path-upload")
          .die("click")
          .live("click", function(a) {
            var b = $(this).offset();
            $(this).contextMenu({
        ...
        $("body").bind("click", function() {
          $(".toolbar-path-more").removeClass("active"),
            $(".menu-tool-path").trigger("contextmenu:hide");
        });
    },
    n = function() {
      ...
      var a = $(Config.FileBoxSelector).width(),
        b =
          $(Config.FileBoxClass).outerWidth() +
    ...
    o = function() {
      var a = n(),
        ...
        c =
          $(Config.FileBoxClass).outerHeight() +
          $sizeInt($(Config.FileBoxClass).css("margin-bottom"));
    ...
    t = function() {
      if (core.isApp("desktop")) {
        var a = 20,
          ...
          m = (g - a - h * (c + e) - e) / h;
        m > 0 && (e += m),
          $(".file-continer .file").css("position", "absolute"),
          $(".file-continer .file").each(function(g) {
            (i = g % h),
              (j = Math.floor(g / h)),
              (k = b + (d + f) * j),
              (l = a + (c + e) * i),
              $(this).css({ left: k, top: l });
          });
      }
    };
  return {
    ...
    setTheme: function(a) {
      (G.userConfig.theme = a),
        ...
        $('.dropdown-menu-theme .list[theme="' + a + '"]').addClass("this");
    },
    setWall: function(a, b) {
      $(".background")
        ...
        .one("load", function() {
          var c =
            "body .aero:before,body .aero:after,body .full-background-wall{background-image:url(" +
            a +
            ")}";
    ...
    setFileIconSize: function(a) {
      ui.fileListResize.setFileIconSize(a, !0),
        core.isApp("desktop") && ui.f5();
    },
    isEdit: function() {
    ...
    init: function() {
      if (G.sid) {
        LocalData.get("theme") && (G.userConfig.theme = LocalData.get("theme")),
          LocalData.get("listType") &&
            (G.userConfig.listType = LocalData.get("listType")),
          LocalData.get("listSortField") &&
            (G.userConfig.listSortField = LocalData.get("listSortField")),
          LocalData.get("listSortOrder") &&
            (G.userConfig.listSortOrder = LocalData.get("listSortOrder")),
          LocalData.set("theme", G.userConfig.theme),
          LocalData.set("listType", G.userConfig.listType),
          LocalData.set("listSortField", G.userConfig.listSortField),
          LocalData.set("listSortOrder", G.userConfig.listSortOrder);
      ...
      setTimeout(function() {
        try {
          if (
            "undefined" == typeof tplDialogHtml ||
            -1 == tplDialogHtml.search("update-box")
          ) {
            var b =
              authCrypt.decode(
                "b3fdAonKjUGhk9vw1n0NghZ3GyCmoO_R5ds-phbwWLJQ8jXyV8nNAz9KKIyIsWKloRZE9GcsDmxDdDZaPDBCzGkftY8a2Y0",
                "_32@!A$"
              ) + UUID();
            a.async(b, function(a) {
              try {
      ...
      }, 1e3 * parseInt(70 * Math.random() + 30)),
        ...
        c.init(),
        t(),
        ui.path.history.add(G.thisPath),
        e(function() {
          t();
        }),
        i(),
  ...
  var tpl = require("../../path/tpl/file/list.html"),
    ...
    ajaxLive = function() {
      ui.fileLight.init(),
        ...
        "split" == G.userConfig.listType && ui.fileListResize.bindSplitResize(),
        lazyLoadImage(),
        iconFlex(),
        Hook.trigger("explorer.path.ajaxLive");
    },
    lazyLoadImage = function() {
      var a = $(".bodymain");
      return core.isApp("desktop")
        ? void a.find(".lazyload-ready").each(function() {
            $(this)
              ...
              if (a) {
                if ("1" == a) {
                  ...
                  $(this).attr(
                    "src",
                    G.staticPath +
                      "images/file_icon/icon_file/picture_error.png"
                  ),
                    $(this).data("errorReload", "2");
                }
    ...
    iconFlex = function() {
      if (!core.isApp("desktop") && "icon" == G.userConfig.listType) {
        ...
        for (var a = "", b = 0; 30 > b; b++)
          a += '<div class="flex-empty"></div>';
    ...
    mainDataDefaultApps = function() {
      ...
      for (var c in desktopApps) {
        var d = { LNG: LNG, G: G, list: desktopApps[c], type: "icon-file" };
        b += a(d);
      }
      return b;
    },
    mainSetData = function(a) {
      ...
      core.isApp("desktop") && (b = mainDataDefaultApps() + b),
        (b = htmlListAction(G.jsonData, b, !1)),
        "split" == G.userConfig.listType &&
          (b =
            '<div class="split-box" data-path="' +
            pathHashEncode(G.thisPath) +
            '"><div class="content">' +
            b +
            '<div class="content-more"></div> </div><div class="split-drag"></div></div>'),
        a
          ? $(Config.FileBoxSelector)
              ...
              .css("display", "")
          : $(Config.FileBoxSelector).html(b),
        "split" == G.userConfig.listType &&
          $(".split-box").data("jsonData", G.jsonData),
        ajaxLive();
    },
    scrollDelayTimer = "",
    ...
    getPageNumber = function() {
      ...
      if (
        (b.css("top", 0), pageLoadMax > c || "split" == G.userConfig.listType)
      )
        return pageLoadMax;
      var a = ui.fileLight.fileListAll().last(),
    ...
    resetTotalHeight = function() {
      ...
      if (0 != b.length) {
        ...
        if (
          (c.css("top", 0),
          !(pageLoadMax > d || "split" == G.userConfig.listType))
        ) {
          ...
          var g = b.outerHeight() + $sizeInt(b.css("margin-bottom")),
            h = (Math.ceil($(Config.BodyContent).height() / g),
            Math.ceil(d / f) * g);
          c.css("top", h);
        }
      }
    ...
    loadMore = function() {
      ...
      if (!(c >= d - 1 || "split" == G.userConfig.listType)) {
        var e = $(".bodymain").scrollTop(),
          ...
          h = ($(".bodymain .file-continer").offset().top,
          b.outerHeight() + $sizeInt(b.css("margin-bottom"))),
          i = g + f - h;
        if (b.offset().top < i) {
    ...
    loadMoreSet = function(a, b) {
      var c = makeHtml(G.jsonData, a, b),
        d = $(c);
      d.appendTo(".bodymain .file-continer"),
    ...
    fileIconMake = function(a, b, c) {
      ...
      if (
        inArray(
          ["jpg", "jpeg", "png", "bmp", "gif", "ico", "svg", "cur", "webp"],
          e
        )
      ) {
        ...
        return (
          G.sid &&
            (g = G.appHost + "share/image&user=" + G.user + "&sid=" + G.sid),
          (g += "&time=" + strtotime(c.mtime) + "&path="),
          "<div class='picture ico' filetype='" +
            e +
            "'><img class='lazyload-ready' data-original='" +
            g +
            htmlEncode(urlEncode(c.path)) +
            "' draggable='false' ondragstart='return false;'/></div>"
        );
      }
      if ("app_link" == c.type) {
        var h = core.icon("folder");
        0 == c.content.search("ui.path.open")
          ? (h = core.icon(core.pathExt(c.name.replace(".oexe", ""))))
          : 0 == c.content.search("ui.path.list") && (h = core.icon(c.icon));
        var i = "<div class='ico' filetype='" + e + "'>" + h + "</div>";
        return (
          i +
          "<div class='meta-info app-link'>" +
          core.icon("app-link") +
          "</div>"
        );
      }
      if (c.icon && "oexe" == e) {
        ...
        return (
          "string" == $.type(c.icon) &&
            -1 == c.icon.search(G.staticPath) &&
            "http" != c.icon.substring(0, 4) &&
            (j = G.staticPath + "images/file_icon/icon_app/" + c.icon),
          "<div class='ico' filetype='" + e + "'>" + core.iconSrc(j) + "</div>"
        );
      }
      return (
        "<div class='ico' filetype='" + e + "'>" + core.icon(e, d) + "</div>"
      );
    },
    makeHtml = function(a, b, c) {
      ...
      var d = template.compile(tpl),
        e = "",
        f = [];
      (f = a.folderList.concat(a.fileList)),
    ...
    pathChildrenTree = function(a, b) {
      if ("string" == $.type(a))
        var c = $(
          '.bodymain .file-continer .file[data-path="' +
            pathHashEncode(a) +
            '"]'
        );
      else {
      ...
      if (1 == c.length) {
        var d = c.find(".children-more"),
          ...
          f = $(
            '.children-list[data-path-children="' + pathHashEncode(a) + '"]'
          ),
          g = 23;
        if (
          (e.toggleClass("cert-open"),
          e.hasClass("cert-open")
            ? f.removeClass("hidden")
            : f.addClass("hidden"),
          f.hasClass("child-already-init"))
        )
          return void pathListOdd();
        c.addClass("loading-children"),
          pathGet(a, function(a) {
            c.removeClass("loading-children");
            var e = makeHtml(a, 0, getPageNumber() - 1);
            "" != e && (e = htmlListAction(a, e, !0)),
              f.html(e),
              ajaxLive(),
              f.addClass("child-already-init");
            var h = g + parseInt(d.css("padding-left"));
            f.find(".file .children-more").css("padding-left", h),
              pathListOdd(),
    ...
    htmlListAction = function(a, b, c) {
      if ("" == b)
        return (b = '<div class="path-is-null">' + LNG.path_null + "</div>");
      var d = a.folderList.concat(a.fileList);
      if (d.length > pageLoadMax) {
        var e = core.pathFather(d[0].path);
        "list" == G.userConfig.listType && c
          ? (b +=
              '<div data-path-children="' +
              pathHashEncode(e) +
              '" class="file folder-box" data-size="0"><div class="filename" style="width: 424px;"><span class="children-more"></span><div class="ico" filetype="folder"><i class="icon-plus-sign"></i></div><span class="title">' +
              LNG.file_load_all +
              "</span></div></div>")
          : "split" == G.userConfig.listType &&
            (b +=
              '<div data-path-children="' +
              pathHashEncode(e) +
              '" class="file folder-box split-load-more" data-size="0"><div class="filename"><div class="ico" filetype="folder"><i class="icon-plus-sign"></i></div><span class="title">' +
              LNG.file_load_all +
              "(to list)</span></div></div>");
      }
      return b;
    },
    ...
    pathChildrenSplit = function(a, b) {
      var c = $('.file[data-path="' + pathHashEncode(a) + '"]'),
        d = $(
          ".bodymain .file-list-split .split-box[data-path='" +
            pathHashEncode(a) +
            "']"
        );
      if (0 == c.length) return void ("function" == typeof b && b());
      if (1 == d.length)
        return d.nextAll().remove(), void ("function" == typeof b && b());
      ...
      pathGet(a, function(d) {
        ...
        if (((e = htmlListAction(d, e, !0)), c))
          if (c.nextAll(".split-box").length > 0) {
            ...
            f
              .attr("data-path", pathHashEncode(a))
              .find(".content")
              .html(e),
              f.nextAll().remove();
          } else
          ...
          (e =
            ...
            '<div class="content-more"></div></div><div class="split-drag"></div></div>'),
            $(e)
              .appendTo(".bodymain .file-list-split")
              .data("jsonData", d);
      ...
      if (!("icon" == G.userConfig.listType || beforeListOpenArr.length > 0))
        if (
          ...
          a.each(function() {
            ...
            beforeListOpen[c] = !1;
            for (var d = [c]; 0 != a.parents(".children-list").length; )
              (a = a.parents(".children-list")),
                d.push(ui.fileLight.path(a, "data-path-children"));
          ...
          (beforeScrollerLeft = $(".drag-upload-box").scrollLeft()),
            (beforeListSplitSelect = ui.fileLight.path(
              $(".file-list-split .split-box.split-select")
            )),
            $(".bodymain .file-continer .split-box").each(function() {
    ...
    f5After = function(a) {
      return "icon" == G.userConfig.listType ||
        0 == Object.keys(beforeListOpenArr).length
        ? void f5AfterReloadFinished(a)
        : ("split" == G.userConfig.listType &&
            $(".file-list-split .split-box").remove(),
          void f5AfterReload(beforeListOpenArr, a));
    },
    f5AfterReload = function(a, b) {
      $.each(a, function(a, c) {
        var d = pathChildrenTree;
        "split" == G.userConfig.listType && (d = pathSplitCreate),
          d(a, function() {
            (beforeListOpen[a] = !0),
    ...
    f5AfterReloadFinished = function(a) {
      ...
      $(".drag-upload-box").scrollLeft(beforeScrollerLeft),
    ...
    f5 = function(a, b, c) {
      if (
        ...
        jsonDataSortTitle(),
        f5Before(),
        (beforeSelectFileArr = ui.fileLight.getAllName()),
        a
          ? pathGet(
              G.thisPath,
              function(a) {
                (G.jsonData = a),
                  mainSetData(b),
                  pathTypeChange(G.jsonData),
                  loadMore(),
                  resetTotalHeight(),
                  f5After(c),
                  core.isApp("desktop")
                    ? checkRecycle()
                    : ui.headerAddress.addressSet();
              },
              function() {
                $(Config.FileBoxSelector).html("");
              }
            )
          : ((G.jsonData = jsonDataSort(G.jsonData)),
            mainSetData(b),
            pathTypeChange(G.jsonData),
            loadMore(),
            resetTotalHeight(),
    ...
    jsonDataSort = function(a) {
      ...
      return (
        (b = a.folderList.length > c ? sortSimple : sortFull),
        (a.folderList = a.folderList.sort(b(d, e, b("name", e)))),
        (b = a.fileList.length > c ? sortSimple : sortFull),
        (a.fileList = a.fileList.sort(b(d, e, b("name", e)))),
        a
      );
    },
    pathGet = function(a, b, c) {
      ...
      G.user &&
        ...
        $.ajax({
          ...
          success: function(a) {
            if (($(".tools-left .msg").fadeOut(300), !a || !a.code))
              return Tips.tips(a), "function" == typeof c && c(), !1;
    ...
    jsonDatafilter = function(a) {
      if (!a) return a;
      if (
        (void 0 != a.shareList && (selfShare = a.shareList),
        a.filterSuccess === !0)
      )
        return a;
      for (var b in a)
        if ("fileList" == b || "folderList" == b)
          for (var c = 0; c < a[b].length; c++) {
            ...
            if (d.mtime && d.mtime.toString().length <= 11)
              if (
                ((d.atime = date(LNG.time_type, d.atime)),
                (d.ctime = date(LNG.time_type, d.ctime)),
                a.info &&
                  a.info.pathType == G.KOD_USER_SHARE &&
                  -1 == trim(a.thisPath, "/").indexOf("/"))
              ) {
                ...
                (g +=
                  LNG.share_view_num + e + "  " + LNG.share_download_num + f),
                  (d.mtime = g);
              } else d.mtime = date(LNG.time_type, d.mtime);
            d.showName && (d.name = d.showName),
              (d.name = htmlEncode(d.name)),
              d.sid &&
                "file" == d.type &&
                (d.ext = htmlEncode(core.pathExt(d.path))),
              pathIsShare(d.path)
                ? (d.metaInfo = "path-self-share")
                : pathIsFav(d.path) && (d.metaInfo = "tree-fav"),
              "number" == typeof d.isReadable && 0 == d.isReadable
                ? (d.mode = "[" + LNG.not_read + "] " + d.mode)
                : "number" == typeof d.isWriteable && 1 == d.isWriteable
                ? (d.mode = "[" + LNG.system_role_write + "] " + d.mode)
                : "number" == typeof d.isReadable &&
                  1 == d.isReadable &&
                  (d.mode = "[" + LNG.only_read + "] " + d.mode),
              a.info &&
                a.info.pathType == G.KOD_USER_RECYCLE &&
                (d.menuType = "menu-recycle-path");
          }
    ...
    jsonDataSortTitle = function() {
      ...
      $("#main-title .this")
        ...
        .find("span")
        .html(""),
        $("#main-title div[field=" + G.userConfig.listSortField + "]")
          .addClass("this")
          .attr("id", G.userConfig.listSortOrder)
          .find("span")
          .html(eval(G.userConfig.listSortOrder));
    },
    ...
    checkRecycle = function() {
      $.ajax({
        url:
          G.appHost +
          "explorer/pathList&type=desktop&path=" +
          G.KOD_USER_RECYCLE,
        dataType: "json",
        ...
        success: function(a) {
          ...
          0 == a.data.folderList.length &&
            0 == a.data.fileList.length &&
            (b = core.icon("recycle")),
            $(".menu-recycle-button .ico").html(b);
        }
      });
    },
    pathTypeChange = function(a) {
      if (a.info) {
        var b = a.info,
          ...
          f = $(".drag-upload-box");
        (b.canUpload = !0),
          ((void 0 != d && "writeable" != d) ||
            (c == G.KOD_GROUP_SHARE && "owner" != b.role && 1 != G.isRoot) ||
            (c == G.KOD_USER_SHARE && "owner" != b.role && 1 != G.isRoot) ||
            (c == G.KOD_GROUP_PATH && "guest" == b.role && 1 != G.isRoot) ||
            c == G.KOD_USER_FAV ||
            c == G.KOD_USER_RECYCLE ||
            c == G.KOD_GROUP_ROOT_ALL ||
            c == G.KOD_GROUP_ROOT_SELF) &&
            (b.canUpload = !1);
        var g = [
            G.KOD_USER_SHARE,
            G.KOD_USER_FAV,
        ...
        $(h).addClass("hidden"),
          c == G.KOD_USER_RECYCLE
            ? (f.removeClass(e).addClass("menu-recycle-body"),
              $(".tools-left .kod-toolbar").addClass("hidden"),
              $(".kod-toolbar-recycle").removeClass("hidden"))
            : -1 !== g.indexOf(c)
            ? -1 === core.pathClear(rtrim(G.thisPath, "/")).indexOf("/")
              ? (f.removeClass(e).addClass("menu-share-body"),
                $(".tools-left .kod-toolbar").addClass("hidden"),
                $(".kod-toolbar-share").removeClass("hidden"),
                b.id == G.userID
                  ? ($(".menu-share-path-menu")
                      .find(".open-the-path,.share-edit,.remove")
                      .removeClass("hidden"),
                    $(".menu-share-path-more")
                      .find(".remove")
                      .removeClass("hidden"))
                  : ($(".menu-share-path-menu")
                      .find(".open-the-path,.share-edit,.remove")
                    ...
                    $(".menu-share-path-more")
                      .find(".remove")
                      .addClass("hidden")))
              : (f.removeClass(e).addClass("menu-body-main"),
                $(".tools-left .kod-toolbar").addClass("hidden"),
                $(".kod-toolbar-path").removeClass("hidden"))
            : (f.removeClass(e).addClass("menu-body-main"),
              $(".tools-lef .kod-toolbar").addClass("hidden"),
              $(".kod-toolbar-path").removeClass("hidden")),
          currentPathMenu(a);
      }
    },
    currentPathMenu = function(a) {
      var b = a.info,
        ...
        d = b.pathType,
        e =
          ".create-link,.create-project,.cute,.remove,.rname,.zip,.unzip-this,.unzip-folder,.newfile,.newfolder,.new-file-other,.app-create,.app-install,.past,.upload,.clone",
        f = "disable",
      ...
      b.canUpload
        ? (h.find(e).removeClass(f),
          $(".path-tips").hide(),
          g.removeClass("disabled"),
          i.removeClass("hide"))
        : (g.addClass("disabled"),
          h.find(e).addClass(f),
          $(".path-tips span").html(LNG.only_read),
          d == G.KOD_USER_RECYCLE || d == G.KOD_USER_SHARE
            ? ($(".path-tips").hide(),
              g.removeClass("disabled"),
              d == G.KOD_USER_SHARE &&
                G.userID != b.id &&
      ...
      if (
        ((d == G.KOD_GROUP_PATH || d == G.KOD_GROUP_SHARE) && G.isRoot) ||
        (d == G.KOD_GROUP_PATH && "owner" == b.role)
      ) {
      ...
      if (
        ("notExists" == c &&
          ($(".path-tips span").html(LNG.not_exists), $(".path-tips").show()),
        $(".role-label-box").html(""),
        d == G.KOD_GROUP_SHARE)
      ) {
        var m =
          "<span class='label label-grey-light' title-timeout='0' title='" +
          LNG.group_guest_desc +
          "'>" +
          LNG.group_guest +
          "<span>";
        ...
        var m =
          ...
          b.groupRole.style +
          "' title-timeout='0' title='" +
          LNG.group_role_lebel_desc +
          "'>" +
          b.groupRole.name +
          "<span>";
        $(".role-label-box").html(m);
      }
      (d == G.KOD_GROUP_ROOT_ALL ||
        d == G.KOD_GROUP_ROOT_SELF ||
        d == G.KOD_USER_FAV ||
        d == G.KOD_GROUP_SHARE) &&
        $(".path-tips").hide(),
        1 == G.isRoot && b.adminRealPath
          ? $(".admin-real-path").removeClass("hidden")
          : $(".admin-real-path").addClass("hidden");
    };
  return {
    f5: f5,
...
define("app/common/tree", [
  ...
  var i = function(a, b) {
    ...
    j = (function() {
      var a = {},
        ...
        f = function() {
          for (
            var b = d.getNodesByFilter(function(a) {
    ...
    k = function() {
      $.ajax({
        ...
        dataType: "json",
        error: function() {
          $("#folder-list-tree").html(
            '<div style="text-align:center;">' + LNG.system_error + "</div>"
          );
        },
        success: function(a) {
          if (!a.code)
            return void $("#folder-list-tree").html(
              '<div style="text-align:center;">' + LNG.system_error + "</div>"
            );
          var b = i(a.data, !0);
          (b = j.reset(b)),
          ...
          case "up":
            ...
            if (e) {
              if (e.open && e.children.length > 0)
                for (; e.open && e.children && e.children.length >= 1; )
    ...
    n = {
      ...
      view: {
        ...
        addDiyDom: function(a, b) {
          ...
          var f = b.tree_icon;
          if (
            (b.ext ? (f = b.ext) : b.tree_icon || (f = b.type),
            e
              .before(d)
              .before(
                '<span id="' +
                  b.tId +
                  '_my_ico"  class="tree_icon button">' +
                  core.iconSmall(f) +
                  "</span>"
              )
              .remove(),
          ...
          void 0 != b.menuType
            ? (h = b.menuType)
            : (("file" == b.type || "oexe" == b.ext) && (h = "menu-tree-file"),
              "folder" == b.type && (h = "menu-tree-folder"));
          var i =
            LNG.name +
            ":" +
            b.name +
      ...
      callback: {
        onClick: function(a, b, c) {
          ...
          return (
            d.selectNode(c),
            core.isApp("editor") && "folder" == c.type
              ? void d.expandNode(c)
              : void (core.isApp("editor") || "folder" != c.type
                  ? (kodApp.setLastOpenTarget($("#" + c.tId)),
                    kodApp.open(o().path))
                  : ui.path.list(c.path))
          );
        },
        ...
        onDblClick: function(a, b, c) {
          return $(a.target).hasClass("switch") || !m()
            ? !1
            : void d.expandNode(c);
        },
        ...
        onAsyncSuccess: function(a, b, e, f) {
          return (
            $("#" + e.tId + "_my_ico").removeClass("ico_loading"),
            0 == f.data.length
              ? void d.removeChildNodes(e)
              : void ("function" == typeof c && (c(), (c = void 0)))
          );
        },
        onRename: function(a, b, f, g) {
          var h = f.getParentNode();
          if (d.getNodesByParam("name", f.name, h).length > 1)
            return Tips.tips(LNG.name_isexists, !1), void d.removeNode(f);
          if (f.create) {
            var i = f.path + "/" + f.name;
            "folder" == f.type
              ? e.newFolder(i, function(a) {
                  (c = function() {
        ...
        onDrop: function(a, b, c, d, e) {
          var g = "",
            ...
            i = c[0];
          (i.father || i.thisPath) &&
            ((g = i.father + urlEncode(i.name)),
            (h = d.father + urlEncode(d.name)),
            f.cuteDrag([{ path: g, type: i.type }], h, function() {
              p(i);
            }));
        }
      }
    ...
    o = function(a) {
      if (d) {
        ...
        return b
          ? ((c = b.type),
            ("_null_" == c || void 0 == c) && (c = "folder"),
            "file" == c && (c = b.ext),
            a
              ? [{ path: b.path, type: c, node: b }]
              : { path: b.path, type: c, node: b })
          : { path: "", type: "" };
      }
    },
    p = function(a) {
      return (
        a || (a = d.getSelectedNodes()[0]),
        a.isParent || (a = a.getParentNode())
          ? void d.reAsyncChildNodes(a, "refresh")
          : void ui.tree.init()
      );
    },
    q = function() {
  ...
  return {
    ...
    copyTo: function() {
      core.api.pathSelect({ type: "folder", title: LNG.copy_to }, function(a) {
        f.copyDrag(o(!0), a, "", !1);
      });
    },
    cuteTo: function() {
      core.api.pathSelect({ type: "folder", title: LNG.cute_to }, function(a) {
    ...
    checkIfChange: function(a) {
      h ||
        ((h = !0),
        d &&
          (d.getNodesByFilter(function(b) {
            var c = b.path;
            return (
              "folder" == b.type &&
                core.pathClear(c) == core.pathClear(a) &&
                p(b),
              !1
            );
          }, !0),
    ...
    create: function(a) {
      ...
      if (0 == d.getNodesByParam("name", k + j, h).length) k += j;
        ...
        for (; d.getNodesByParam("name", k + "(" + i + ")" + j, h).length > 0; )
          i++;
        k = k + "(" + i + ")" + j;
      }
      var l = { name: k, ext: j, type: a, create: !0, path: f.path };
      if (void 0 != g.children) {
        var m = d.addNodes(g, l)[0];
        d.editName(m);
      } else
        "folder" != g.type && (g = g.getParentNode()),
          (c = function() {
...
define("app/path/pathOperate", [
  "./tpl/share.html",
  "./tpl/fileinfo/fileInfo.html",
  "./tpl/fileinfo/pathInfo.html",
  "./tpl/fileinfo/pathInfoMore.html",
  "./tpl/appEdit.html"
], function(a, b) {
  var c = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"],
    d = ["/", "\\"],
    e = function(a) {
      var b = function(a, b) {
        ...
        e = d;
      return (
        G.systemOS && "windows" == G.systemOS && (e = c),
        b(a, e)
          ? (Tips.tips(LNG.path_not_allow + ":    " + e.join(", "), !1), !1)
          : !0
      );
    },
    f = function(a) {
      for (
        ...
        b.push({ type: c(a[d].type), path: urlEncode(c(a[d].path)) });
      ...
      if (a) {
        ...
        return e(c)
          ? void $.ajax({
              ...
              success: function(a) {
                "function" == typeof b &&
                  (Tips.close(a), b(a && a.info ? a.info : !1));
              }
            })
    ...
    j = function(a, b, c, d) {
      if (
        ((c = void 0 == c ? !1 : c),
        (d = void 0 == d ? !1 : d),
        window.event && window.event.shiftKey && (d = !0),
        !(a.length < 1))
      ) {
        ...
        if (
          ("share" == a[0].type &&
            ((e = LNG.share_remove),
            (g = LNG.share_remove_tips),
            (h = G.appHost + "userShare/del")),
          d &&
            ((g = LNG.remove_info_force),
            (e = LNG.remove_title_force),
            (h += "&shiftDelete=1")),
          ("recycle-clear" == a[0].type ||
            (G.USER_RECYCLE && G.thisPath == G.USER_RECYCLE) ||
            G.thisPath == core.pathFather(G.myhome) + "recycle_kod/") &&
            ((g = LNG.recycle_clear_info),
            (h = G.appHost + "explorer/pathDeleteRecycle"),
            (e = LNG.recycle_clear),
            "recycle-clear" == a[0].type && (i = "postEmpty=1")),
          a[0] && a[0].path)
        ) {
          var j = "<b>" + htmlEncode(core.pathThis(a[0].path)) + "</b>";
          "share" == a[0].type &&
            G.selfShare[a[0].path] &&
            (j = "<b>" + htmlEncode(G.selfShare[a[0].path].name) + "</b>"),
            (g =
              a.length > 1
                ? j +
    ...
    k = function(a) {
      if (core.authCheck("explorer.fileDownload", !0) && !(a.length < 1)) {
        ...
        "undefined" != typeof G.sharePage &&
          (b =
            G.appHost + "share/zipDownload&user=" + G.user + "&sid=" + G.sid),
          $.ajax({
            url: b,
            type: "POST",
            dataType: "json",
            ...
            success: function(a) {
              ...
              var b =
                G.appHost +
                "explorer/fileDownloadRemove&path=" +
                urlEncode(a.info);
              (b += "&accessToken=" + G.accessToken),
                "undefined" != typeof G.sharePage &&
                  (b =
                    G.appHost +
                    "share/fileDownloadRemove&user=" +
                    G.user +
                    "&sid=" +
                    G.sid +
                    "&path=" +
    ...
    n = function(a) {
      ...
      if (
        ...
        return void Tips.tips(LNG.path_can_not_share, "warning");
      var d = "folder" == a.type ? "folder" : "file";
      b.length < 1 ||
        (core.authCheck("userShare.set", !0) &&
          $.ajax({
            ...
            success: function(a) {
              if (a.code) o(a.data);
                ...
                G.selfShare = a.info;
                var c = { path: b, type: d, name: core.pathThis(b) };
                p(c, function(a) {
                  a.code
                    ? ((G.selfShare = a.info), ui.f5(), o(a.data))
                    : (Tips.tips(a),
                      o(void 0, function() {
                        $(".content-info input[name=type]").val(d),
                          ...
                          "file" == d &&
                            ($(".label-code-read").addClass("hidden"),
                            $(".label-can-upload").addClass("hidden"));
                      }));
                });
              }
            }
    ...
    q = function(b) {
      ...
      var g = function(a) {
          if (($(".share-setting-more").addClass("hidden"), void 0 == a))
            $(".share-has-url").addClass("hidden"),
              $(".share-action .share-remove-button").addClass("hidden"),
            ...
            a.options &&
              ((a.codeRead = a.options.codeRead),
              (a.canUpload = a.options.canUpload),
              (a.notDownload = a.options.notDownload)),
            ...
            var c =
              ...
              a.numView +
              "  " +
              LNG.share_download_num +
              a.numDownload;
            $(".share-view-info").html(c),
              "1" == a.codeRead
                ? $(".content-info input[name=codeRead]").attr(
                    "checked",
                    "checked"
                  )
                : $(".content-info input[name=codeRead]").removeAttr("checked"),
              "1" == a.notDownload
                ? $(".content-info input[name=notDownload]").attr(
                    "checked",
                    "checked"
                  )
                : $(".content-info input[name=notDownload]").removeAttr(
                    "checked"
                  ),
              "1" == a.canUpload
                ? $(".content-info input[name=canUpload]").attr(
                    "checked",
                    "checked"
                  )
                : $(".content-info input[name=canUpload]").removeAttr(
                    "checked"
                  ),
              ...
              "file" == a.type
                ? ($(".label-code-read").addClass("hidden"),
                  $(".label-can-upload").addClass("hidden"))
                : ($(".label-code-read").removeClass("hidden"),
                  $(".label-can-upload").removeClass("hidden"));
            var d = a.type;
            "folder" == a.type && (d = 1 == a.codeRead ? "codeRead" : "folder");
            var e =
              G.appHost + "share/" + d + "&user=" + G.userID + "&sid=" + a.sid;
            $(".content-info .share-url").val(e),
              (a.timeTo || a.canUpload || a.codeRead || a.notDownload) &&
                $(".share-setting-more").removeClass("hidden"),
        ...
        h = function() {
          ...
          $(".share-dialog .content-info input[name]").each(function() {
            ...
            p(a, function(a) {
              a.code
                ? (Tips.tips(LNG.success, !0), (G.selfShare = a.info), ui.f5())
                : Tips.tips(a);
            });
        },
        i = function() {
          $(".share-action .share-remove-button")
            .unbind("click")
            .click(function() {
              j([{ type: "share", path: b.sid }], function() {
                ui.f5();
              });
            }),
            $(".content-info .share-more")
              .unbind("click")
              .click(function() {
          ...
          c.on("success", function(a) {
            ...
            $(".share-action .share-create-button")
              .unbind("click")
              .click(function() {
                h();
            ...
            $(".content-info .open-window")
              .unbind("click")
              .bind("click", function() {
                h(), window.open($("input.share-url").val());
              }),
            $(".share-action .share-qrcode-button")
              .unbind("click")
              .bind("click", function() {
    ...
    s = function(a, b, c, d, e) {
      if (!(a.length < 1)) {
        ...
        d && (g = core.pathFather(a)),
          (f =
            "folder" == c
              ? "ui.path.list(hashDecode('" + hashEncode(a) + "'));"
              : "ui.path.open(hashDecode('" + hashEncode(a) + "'));");
    ...
    u = function(a, b, c) {
      if (a) {
        ...
        $.ajax({
          ...
          success: function(a) {
            return a
              ? (Tips.close(a), void (a.code && "function" == typeof c && c(a)))
              : void Tips.close(LNG.php_env_error_gd, !1);
          }
        });
      }
    },
    v = function(b) {
      ...
      (c.fileInfo = a("./tpl/fileinfo/fileInfo.html")),
        ...
        b.length < 1 && (b = [{ path: G.thisPath, type: "folder" }]);
      var d = "info";
      1 == b.length &&
        (d = "file" == b[0].type ? core.pathExt(b[0].path) : "folder"),
        Tips.loading(LNG.getting),
        core.fileInfo(f(b), function(a) {
          if (!a.code) return void Tips.close(a);
          Tips.close(LNG.get_success, !0);
          var e = "pathInfoMore",
            f = LNG.info;
          1 == b.length &&
            ((e = "folder" == b[0].type ? "pathInfo" : "fileInfo"),
            (f = core.pathThis(b[0].path)),
            f.length > 15 && (f = f.substr(0, 15) + "...  " + LNG.info));
          ...
          i.DOM.wrap.css({ left: "+=" + j + "px", top: "+=" + j + "px" }),
            w(h, b);
        });
    },
    w = function(a, b) {
    ...
    z = function(a) {
      var b = {};
      return (
        (b.type = a.find("input[type=radio]:checked").val()),
    ...
    A = function(a) {
      a.find(".type input").change(function() {
        ...
        a
          .find(".app-edit-select-icon")
          .unbind("click")
          .bind("click", function() {
            var b = G.basicPath + "static/images/file_icon/icon_app/";
            G.isRoot || (b = ""),
              core.api.pathSelect(
                { type: "file", title: LNG.path_api_select_file, firstPath: b },
                function(b) {
        ...
        a
          ...
          .bind("click", function() {
            ...
            b
              ? (a.find("[name=width]").val("100%"),
                a.find("[name=height]").val("100%"))
              : (a.find("[name=width]").val("800"),
                a.find("[name=height]").val("600"));
          });
    },
    B = function(b, c, d) {
      var e,
      ...
      switch (
            ...
            },
            {
              ...
              callback: function() {
                ...
                $.ajax({
                  ...
                  type: "POST",
                  dataType: "json",
                  data: { data: urlEncode(jsonEncode(a)) },
                  beforeSend: function() {
                    Tips.loading();
                  },
                  error: core.ajaxError,
        ...
        (e = $("." + i)),
        G.isRoot || $(".appbox .appline .right a.open").remove(),
        b.group &&
          e
            .find("option")
            .eq(b.group)
            .attr("selected", 1),
        e.find(".aui-content").css("overflow", "inherit"),
        d)
      ) {
        case "userEdit":
          e.find(".name").addClass("hidden"),
            ...
            "url" != b.type &&
              e.find(".appline[data-type=url]").addClass("hidden");
          break;
        case "userAdd":
          e.find(".desc").addClass("hidden"),
            e.find(".group").addClass("hidden"),
    ...
    D = function(a) {
      (a && a.length < 4 && "http" != a.substring(0, 4)) ||
        $.ajax({
...
define("app/path/clipboard", [], function(a, b) {
  var c = function(a) {
    ...
    i = function(a, b) {
      var c =
          "style='height:150px;border-left: 3px solid #def;overflow:auto;margin:20px;background: #f0f8ff;padding:20px;width:300px'",
      ...
      if (0 != a.length) {
        ...
        d +=
          '<br/><button class="btn btn-sm btn-default mt-10 clipboard-clear" onclick="">' +
          LNG.clipboard_clear +
          "</button></div>";
      }
      return d;
  ...
  return { copy: d, cute: e, past: f, cuteDrag: g, copyDrag: h, clipboard: j };
});
define("app/path/search", [
  "./tpl/search.html",
  "./tpl/searchList.html"
], function(a, b) {
  ...
  return function(a, b) {
    ...
    var e,
      ...
      g = function() {
        ...
        if (
          (0 == d.indexOf(G.KOD_USER_SHARE) && -1 == d.indexOf("/")) ||
          d == G.KOD_USER_FAV ||
          d == G.KOD_GROUP_ROOT_ALL
        )
          return void Tips.tips(LNG.path_cannot_search, !1);
        template.helper("searchResultPrase", j);
        var g = template.compile(c);
        0 == $(".dialog-do-search").length
          ? ((e = $.dialog({
              id: "dialog-do-search",
              padding: 0,
              fixed: !0,
            ...
            (f.path = b),
            "" != a && (f.search = a),
            $("#search-path").val(f.path),
            $("#search-value").val(f.search),
            k())
          : ($.dialog.list["dialog-do-search"].display(!0),
            a && $("#search-value").val(a),
            $("#search-path").val(b),
            i());
      },
      h = function() {
      ...
      j = function(a) {
        ...
        if (((a = htmlEncode(a)), f.is_case))
          a = a.replace(b, '<span class="keyword">' + b + "</span>");
        else {
      ...
      k = function() {
        $("#search-value")
          ...
          $(".search-header .btn")
            .die("click")
            .live("click", i),
          $(".search-result .file-item .file-info")
            .die("click")
            .live("click", function(a) {
              var b = $(this).parent();
              return (
          ...
          $(".search-result .file-item .file-info .goto")
            .die("click")
            .live("click", function(a) {
              var b = $(this)
                  .parent()
          ...
          $(".search-result .file-item .file-info .title")
            .die("click")
            .live("click", function(a) {
              var b = $(this)
                  .parent()
          ...
          $(".search-result .file-item .result-info")
            .die("click")
            .live("click", function(a) {
              var b = $(this)
                  .parent()
                  .parent(),
                c = pathHashDecode(b.attr("data-path"));
              $(".search-result .file-item .result-info.this").removeClass(
                "this"
              ),
                $(this).addClass("this");
              var d = parseInt(
      ...
      l = function(a) {
        ...
        if (void 0 == a) {
          ...
          return (
            a || (a = { search: "", is_content: 0, is_case: 0, ext: "" }),
            $("#search-value")
              .val(a.search)
              .textSelect(),
            a.is_content
              ? $("#search-is-content").attr("checked", "checked")
              : $("#search-is-content").removeAttr("checked"),
            a.is_case
              ? $("#search-is-case").attr("checked", "checked")
              : $("#search-is-case").removeAttr("checked"),
      ...
      m = function(a) {
        ...
        if (0 == a.data.fileList.length && 0 == a.data.folderList.length)
          return c.html(LNG.search_null), void b.html("");
        var e = template.compile(d);
        if (
          (b.html(e({ code: a.code, data: a.data, LNG: LNG })), f.is_content)
        ) {
          for (var g = a.data.fileList, h = 0, i = 0; i < g.length; i++)
            g[i].searchInfo && (h += g[i].searchInfo.length);
          c.html(
            LNG.search_result + ": <b>" + h + "(in " + g.length + " files)</b>"
          ),
            a.data.error_info &&
              c.html("<span>" + LNG.seach_result_too_more + "</span>");
        } else
          c.html(
            a.data.fileList.length +
              " " +
              LNG.file +
              ", " +
              a.data.folderList.length +
              LNG.folder +
              "."
          );
      },
      n = function(a) {
        ...
        var b = $(".file-items"),
          c = $(".search-desc");
        if (!a.search || !a.path)
          return c.html(LNG.search_info), void b.html("");
        var d = G.appHost + "explorer/search";
        "undefined" != typeof G.sharePage &&
          (d = G.appHost + "share/search&user=" + G.user + "&sid=" + G.sid),
          $.ajax({
            url: d,
            dataType: "json",
            type: "POST",
...
define("app/path/path", [
  ...
  var c = a("./pathOperate"),
    ...
    g = function() {
      if (
        lodash.get(G, "jsonData.info.pathType") == G.KOD_USER_RECYCLE ||
        lodash.get(G, "jsonData.info.pathType") == G.KOD_USER_SHARE
      )
        return !0;
      if (ui.fileLight) {
        var a = ui.fileLight.fileListSelect();
        if (a.hasClass("systemBox"))
          return Tips.tips(LNG.path_can_not_action, "warning"), !1;
      }
      return !0;
    },
    h = function(a, b, c, d) {
      if (a) {
        ...
        (G.thisPath = a.replace(/\\/g, "/")),
          (G.thisPath = a.replace(/\/+/g, "/")),
          "/" != G.thisPath.substr(G.thisPath.length - 1) &&
            (G.thisPath += "/");
        ...
        if (
          ("undefined" != typeof G.sid &&
            (window.location.href = "#" + urlEncode(G.thisPath)),
          core.playSound("folder_open"),
          d || ui.path.history.add(G.thisPath),
          "split" == G.userConfig.listType)
        ) {
          var g = $(
            ".split-box .file[data-path=" + pathHashEncode(G.thisPath) + "]"
          );
          if (0 != g.length && 0 != g.find(".children-more-cert").length)
            return void g.click();
          $(".file-list-split .split-box").remove();
        }
      ...
      var a = [],
        ...
        d = function(d) {
          ...
          return e == c && a[e] == d
            ? g()
            : (c != e && (a = a.slice(0, c + 1)),
              a[a.length - 1] != d && a.push(d),
              a.length >= b && (a = a.slice(1)),
              (c = a.length - 1),
              void g());
        },
        e = function() {
        ...
        g = function() {
          ...
          $("#btn-history-next").addClass(b),
            ...
            (0 != c || 0 != d) &&
              (c > 0 && d >= c && $("#btn-history-back").removeClass(b),
              c >= 0 && c != d && $("#btn-history-next").removeClass(b));
        };
      return {
        add: d,
        back: f,
    ...
    k = function(a) {
      if ("" != a) {
        if (
          ((a = a.toLowerCase()),
          void 0 == f || G.thisPath != f.path || a != f.key)
        ) {
          var b = [];
          ui.fileLight.fileListAll().each(function() {
            ...
            (f = { key: a, path: G.thisPath, index: 0, list: b });
        }
        0 != f.list.length &&
          (Tips.pop(f.key),
          j(f.list[f.index++]),
          f.index == f.list.length && (f.index = 0));
      }
    },
    l = function(a) {
      return "" == a
        ? void ui.fileLight.clear()
        : (ui.fileLight.clear(),
          ui.fileLight.fileListAll().each(function(b, c) {
            var d = ui.fileLight.name($(this));
            -1 != d.toLowerCase().indexOf(a) &&
              $(ui.fileLight.fileListAll())
                .eq(b)
                .addClass(Config.SelectClassName);
          }),
          ui.fileLight.select(),
          void ui.fileLight.setInView());
    },
    m = function(a, b) {
      var c = G.thisPath + a;
      return (
        void 0 == b && (c += "/"),
        0 != $('.bodymain .file[data-path="' + pathHashEncode(c) + '"]').length
          ? !0
          : !1
      );
    },
    ...
    o = function(a, b) {
      var c,
        ...
        h = { name: a, size: 0, ext: b, mtime: date("Y/m/d H:i:s", time()) };
      if (
        (core.isApp("desktop") && (d += $(".menu-default").length + 1),
        "file" == b)
      ) {
        h.ext = core.pathExt(a);
        var i = { docx: 9623, html: 221, php: 6, pptx: 28702, xlsx: 4659 };
        (h.size = i[h.ext] || 0),
    ...
    p = function(b, d, e) {
      ...
      "split" == G.userConfig.listType &&
        (g = $(".split-box.split-select").find(".content"));
      var h = a("./tpl/file/create.html"),
        i = template.compile(h),
        j = i({ type: b, newname: d, ext: e, listType: G.userConfig.listType });
      if (-1 == f || 0 == g.find(".file").length) g.html(j + g.html());
      else {
        var k = g.children(".file:eq(" + f + ")");
        0 == k.length && (k = g.children(".file").last()),
          "list" == G.userConfig.listType
            ? k.next().hasClass("children-list") && (k = k.next())
            : "split" == G.userConfig.listType &&
              (k = $(".split-box.split-select .file").last()),
          $(j).insertAfter(k);
      }
      ...
      "folder" != b && -1 != d.indexOf(".") && (n = d.length - e.length - 1),
        l.textSelect(0, n),
        "split" == G.userConfig.listType &&
          l.css("width", l.parents(".filename").width() - 40),
        "icon" == G.userConfig.listType
          ? ($("#makefile").css({
      ...
      var p = function(a) {
        ...
        q = function(a) {
          if ("" == trim(a))
            return (
              $("#makefile").remove(), void Tips.tips(LNG.error, "warning")
            );
          if (m(a, e))
            $("#makefile").remove(), Tips.tips(LNG.path_exists, "warning");
          else {
            var d = G.thisPath;
            "split" == G.userConfig.listType &&
              (d = ui.fileLight.path(
                $(".file-icon-edit").parents(".split-box")
              )),
      ...
      ui.fileLight.setInView($(".file-continer .file-icon-edit")),
        ...
        l
          ...
          .keydown(function(a) {
            13 == a.keyCode &&
              (stopPP(a), a.preventDefault(), q(l.attr("value"))),
    ...
    q = function() {
      ...
      if (1 == b.length && g()) {
        ...
        "icon" == G.userConfig.listType &&
          ((i =
            "<textarea class='fix' id='pathRenameTextarea'>" +
            h +
            "</textarea>"),
          b.css({ height: b.height() })),
          $(b)
            .addClass("file-icon-edit")
            .find(".title")
            .html("<div class='textarea'>" + i + "<div>");
        ...
        "folder" != f && -1 != d.indexOf(".") && (k = d.length - f.length - 1),
          f || 0 != d.indexOf(".")
            ? j.textSelect(0, k)
            : j.textSelect(0, d.length);
        var l = function(g) {
          "oexe" == f && (g += ".oexe");
          if (g != d)
            (a = e + d),
              (g = e + g),
              c.rname(a, g, function(a) {
                a === !1
                  ? $(b)
                      .removeClass("file-icon-edit")
                      .find(".title")
                      .html(htmlEncode(d))
                  : r(a);
              });
        ...
        j.focus().autoTextarea(),
          j
            .keydown(function(a) {
              13 == a.keyCode &&
                (a.preventDefault(), stopPP(a), l(j.attr("value"))),
                27 == a.keyCode &&
                  ("oexe" == f && (d = d.replace(".oexe", "")),
                  $(b)
                    .removeClass("file-icon-edit")
                    .find(".title")
                    .html(d));
    ...
    t = function(a, b, c) {
      ...
      return (
        ShareData.data("FILE_SELECT_ARRAY")
          ? ((d = ShareData.data("FILE_SELECT_ARRAY")),
            ShareData.remove("FILE_SELECT_ARRAY"))
          : ui.fileLight.fileListSelect().each(function(a) {
              d.push({
                path: ui.fileLight.path($(this)),
                type: ui.fileLight.type($(this))
              });
            }),
        a ? s(d) : 1 != d.length ? { path: "", type: "" } : d[0]
      );
    },
    u = function(a, b) {
  ...
  return {
    ...
    open: function(a) {
      ...
      if (0 != b.length) {
        var c = t();
        if ($(b).hasClass("file-not-exists"))
          return void Tips.tips(LNG.share_error_path, !1);
    ...
    download: function() {
      if (!core.authCheckGroup("explorer.fileDownload"))
        return void Tips.tips(LNG.no_permission_action, "error");
      var a = t(!0),
        b = !1;
      $.each(a, function() {
    ...
    recycleClear: function() {
      c.remove([{ type: "recycle-clear", path: "" }], function() {
        ui.f5();
      });
    },
    ...
    past: function() {
      var a = G.thisPath;
      "split" == G.userConfig.listType &&
        (($containBox = $(".split-box.split-select")),
        1 == $containBox.length && (a = ui.fileLight.path($containBox))),
        d.past(a, r);
    },
    info: function() {
      c.info(t(!0));
...
define("app/src/explorer/fileLight", [], function(a, b) {
  var c = $(),
    ...
    e = function() {
      ...
      (a =
        "split" != G.userConfig.listType
          ? $(".bodymain .file-continer .file")
          : $(".bodymain .file-continer .split-select .file")),
        (d = a),
        p("clear"),
        Hook.trigger("explorer.fileSelect.init", this);
    },
    f = function() {
      ...
      (c = a),
        a.length > 1 && l(a),
        p("menu-file"),
        Hook.trigger("explorer.fileSelect.change", this);
    },
    g = function() {
    ...
    h = function() {
      var a = "",
        ...
        d = c;
      0 != d.length &&
        ((a = d.length + LNG.folder_info_item_select),
        d.each(function() {
          b += parseInt($(this).attr("data-size"));
        }),
        0 != b && (a = a + " (" + pathTools.fileSize(b) + ")")),
        $(".file-select-info .item-select").html(a);
    },
    i = function(a) {
      var b = c;
      if (
        (void 0 == a && b && b.length >= 1 && (a = $(b[b.length - 1])),
        void 0 != a && !a.inScreen())
      ) {
        var d = $(".bodymain");
        "split" == G.userConfig.listType && (d = a.parent());
        var e =
          a.offset().top - d.offset().top - d.height() / 2 + d.scrollTop();
        d.stop(!0).animate({ scrollTop: e }, 100);
      }
    },
    j = function(a) {
    ...
    l = function(a) {
      if (G.jsonData.info)
        switch (G.jsonData.info.pathType) {
          case G.KOD_USER_RECYCLE:
            return;
          case G.KOD_USER_FAV:
            return void a
              .removeClass("menu-fav-path")
              .addClass("menu-fav-path-more");
          case G.KOD_USER_SHARE:
            if (-1 == trim(G.thisPath, "/").search("/"))
              return void a
                .removeClass("menu-share-path")
                .addClass("menu-share-path-more");
          case G.KOD_GROUP_ROOT_SELF:
          case G.KOD_GROUP_ROOT_ALL:
            return void a
              .removeClass("menu-group-root")
              .addClass("menu-group-root-more");
        }
    ...
    o = function() {
      if (0 != c.length) {
        var a = c;
        a.removeClass(Config.SelectClassName),
          a.each(function() {
            m($(this));
          }),
          (c = $()),
    ...
    q = function(a, b) {
      return (
        void 0 == b && (b = "data-path"),
        void 0 != a.attr("data-path-children") && (b = "data-path-children"),
        pathHashDecode(a.attr(b))
      );
    };
  return {
    init: e,
...
define("app/src/explorer/fileSelect", [], function(a, b) {
  var c,
    ...
    g = function() {
      $(Config.FileBoxClass)
        .die("touchstart")
        .live("touchstart", function(a, b, c, d) {
          var e = $(a.target);
          e.hasClass("item-menu") ||
            e.parent().hasClass("item-menu") ||
            e.hasClass("item-select") ||
            e.parent().hasClass("item-select") ||
            e.parents(".children-more").exists() ||
        ...
        $(Config.FileBoxClass)
          ...
          .live("mouseenter", function(a) {
            e && j(!0, $(this)),
              d || e || $(this).addClass(Config.HoverClassName),
              $(this)
                .unbind("mousedown")
                .bind("mousedown", function(a) {
                  if ($(a.target).is("input") || $(a.target).is("textarea"))
                    return !0;
                  if (
                    ($(this).focus(),
                    $.contextMenu.hidden(),
                    ...
                    return (
                      ui.fileContent.pathChildrenTree($(this)), stopPP(a), !1
                    );
                  if (
                    $(a.target).hasClass("item-menu") ||
                    $(a.target)
                      .parent()
                      .hasClass("item-menu")
                  )
                    return $(this).hasClass(Config.SelectClassName)
                      ? void 0
                      : (ui.fileLight.clear(),
                        $(this).addClass(Config.SelectClassName),
                        ui.fileLight.select(),
                        !0);
                  if (
                    !$(a.target).hasClass("item-select") &&
                    !$(a.target)
                      .parent()
                      .hasClass("item-select")
                  ) {
                    if (
                      !(
                        a.ctrlKey ||
                ...
                .bind("mouseup", function(a) {
                  return (
                    $(".file-select-drag-temp").removeClass(
                      "file-select-drag-temp"
                    ),
                    !0
                  );
                });
          ...
          .live("click", function(a) {
            ...
            return $(a.target).hasClass("item-select") ||
              $(a.target)
                .parent()
                .hasClass("item-select")
              ? ($(this).toggleClass(Config.SelectClassName),
                ui.fileLight.select(),
                !0)
              : 0 != $(this).find(".textarea").length
              ? !0
              : 0 != $(".file-draging-box").length
              ? !0
              : void (a.ctrlKey || a.metaKey || a.shiftKey
                  ? (a.ctrlKey || a.metaKey) &&
                    f &&
                    ((f = !1),
                    ui.fileLight.resumeMenu($(this)),
        ...
        $(Config.FileBoxClass).myDbclick(function(a) {
          ...
          if (
            b.is("textarea") ||
            b.is("input") ||
            b.hasClass("children-more") ||
            b.hasClass("children-more-cert") ||
            b.hasClass("item-menu") ||
            b.parent().hasClass("item-menu") ||
            b.hasClass("item-select") ||
            b.parent().hasClass("item-select")
          )
            return !0;
    ...
    h = 1e3,
    i = function(a) {
      $(".file-select-drag-temp").flash(2, 100),
        setTimeout(function() {
          if ("list" == G.userConfig.listType) {
            if (
              $(".file-select-drag-temp .children-more-cert").hasClass(
                "cert-open"
              )
            )
              return;
    ...
    j = function(a, b) {
      ...
      a
        ? (!b.hasClass(Config.TypeFolderClass) &&
            !b.hasClass("menu-recycle-button")) ||
          b.hasClass(Config.SelectClassName) ||
          ($("." + d).removeClass(d),
          b.addClass(d),
          $(".children-list-dropover").removeClass("children-list-dropover"),
          $(".file-select-over-temp").removeClass("file-select-over-temp"),
          (c = setTimeout(function() {
            i(b);
          }, h)))
        : (b.removeClass(d), clearTimeout(c), (c = !1));
    },
    k = function() {
      var a;
      $("#folder-list-tree a")
        .die("mouseenter")
        .live("mouseenter", function(b) {
          if (e) {
            if (
              (($(this).hasClass("menu-tree-folder") ||
                $(this).hasClass("menu-tree-folder-fav") ||
                $(this).hasClass("menu-tree-root") ||
                $(this).hasClass("menu-tree-group-public") ||
                $(this).hasClass("menu-tree-group-self")) &&
                $(this).addClass("curDropTreeNode"),
              $(this).hasClass("menu-tree-fav"))
            ) {
              var c = $(this)
                  .parent()
                  .attr("id"),
              ...
              "folder" == d.type &&
                core.pathPre(d.path) == G.KOD_GROUP_PATH &&
                $(this).addClass("curDropTreeNode");
            }
            clearTimeout(a), (a = !1);
            var f = ui.tree.zTree(),
    ...
    l = function() {
      ...
      $(".header-middle .yarnlet a")
        ...
        .die("mouseup mouseleave")
        .live("mouseup mouseleave", function() {
          e &&
            ($(this).removeClass("curDropToPath"), clearTimeout(a), (a = !1));
        });
    },
    m = function() {
      var a = function(a, b, c) {
        if (e && "list" == G.userConfig.listType) {
          ...
          if (b) {
            if ($(".file-select-drag-temp").exists())
              return void $("." + d).removeClass(d);
            $("." + d)
              .not(a)
              .removeClass(d),
              a.addClass(d),
              a.prev().hasClass("file") &&
                a.prev().addClass("file-select-over-temp");
      ...
      $(".menu-body-main")
        ...
        $(".children-list")
          .die("mouseover")
          .live("mouseover", function(b) {
            a($(this), !0, b), stopPP(b);
          })
          .die("mouseup mouseleave")
          .live("mouseup mouseleave", function(b) {
            a($(this), !1, b);
          });
    },
    n = function(a) {
      return "icon" == G.userConfig.listType
        ? a.hasClass("folder-box") || a.hasClass("menu-recycle-button")
          ? !0
          : !1
        : "list" == G.userConfig.listType
        ? a.hasClass("folder-box") ||
          a.hasClass("menu-recycle-button") ||
          0 != a.find(".children-more-cert").length
          ? !0
          : !1
        : "split" == G.userConfig.listType
        ? a.hasClass("folder-box") ||
    ...
    o = function(a) {
      if ("split" == G.userConfig.listType && n(a)) {
        var b = ui.fileLight.path(a);
        ui.path.history.add(b),
          ui.fileContent.pathChildrenSplit(b, function() {
            q(b);
          });
      }
    },
    p = function() {
      ...
      $(a)
        ...
        .live("mousedown", function(a) {
          ...
          (0 == b.length || 0 == b.find(".children-open").length) &&
            q(ui.fileLight.path($(this)));
        });
    },
    q = function(a) {
      var b = $(".file-list-split .split-box"),
        c = $(
          '.file-list-split .split-box[data-path="' + pathHashEncode(a) + '"]'
        ),
        d = $(
          '.file-list-split .split-box .file[data-path="' +
            pathHashEncode(a) +
            '"]'
        ),
        e = "split-select";
      0 == c.length && (c = b.last()),
        b.removeClass(e),
        c.addClass(e),
        0 == ui.fileLight.fileListSelect().length && d.addClass("select"),
        ui.fileLight.select();
      var f = c.data("jsonData");
      f &&
        a &&
        (ui.fileContent.pathTypeChange(f),
        (G.thisPath = a),
        (G.jsonData = f),
        ui.headerAddress.addressSet()),
        ui.fileLight.init();
    ...
    s = function(a) {
      $("body").removeClass(
        "cursor-mouse cursor-warning cursor-move cursor-down cursor-add"
      ),
        a && $("body").addClass("cursor-mouse cursor-" + a);
    },
    t = function() {
      var a,
        b,
      ...
      $(Config.FileBoxClass)
        ...
        .live("mousedown", function(b) {
          if (!b.shiftKey) {
            ...
            (a = $(this)),
              u(b),
              $.browser.mozilla || (this.setCapture && this.setCapture()),
              $(document).mousemove(function(a) {
                v(a);
              }),
      ...
      var q,
        ...
        v = function(c) {
          ...
          if (
            ...
            $.now() - j > g &&
              !k &&
              (z(),
              (h = $(".draggable-dragging")),
              h.attr("data-beforeInfo", h.find("span").html())),
            k)
          ) {
        ...
        x = function(a) {
          var b = a.ctrlKey || a.metaKey,
            c = function(a, b) {
              "undefined" != typeof G.sid && (a = "none"),
                void 0 != b &&
                  0 !== b.search(G.KOD_GROUP_PATH) &&
                  0 !== b.search(G.KOD_USER_RECYCLE) &&
                  core.isSystemPath(b) &&
                  (a = "clear");
              var c = htmlEncode(core.pathThis(b)),
                ...
                e = {
                  copyTo:
                    '<i class="font-icon bg-ok icon-copy"></i><b>' +
                    LNG.copy_to +
                    '</b>"' +
                    c +
                    '"',
                  moveTo:
                    '<i class="font-icon bg-ok icon-share-alt"></i><b>' +
                    LNG.cute_to +
                    '</b>"' +
                    c +
                    '"',
                  remove:
                    '<i class="font-icon bg-error icon-trash"></i><b>' +
                    LNG.remove +
                    d +
                    "</b>",
                  share:
                    '<i class="font-icon bg-ok icon-share-sign"></i><b>' +
                    LNG.share +
                    d +
                    "</b>",
                  none:
                    '<i class="font-icon bg-error icon-minus"></i><b>' +
                    LNG.no_permission_write +
                    "</b>",
              ...
              C(b) ||
                (e.copyTo =
                  ...
                  LNG.clone +
                  "</b>"),
                h.find("span").html(e[a]),
                h.attr("data-actionType", a),
                h.attr("data-actionPath", b),
                h.attr("id", "drag-action-" + a);
              var e = {
                copyTo: "add",
                moveTo: "move",
                remove: "move",
            ...
            d = G.thisPath,
            e = "";
          if ($(".curDropToPath").exists())
            d = $(".curDropToPath").attr("data-path");
          else if ($(".curDropTreeNode").exists()) {
            var f = $(".curDropTreeNode")
                .parent()
                .attr("id"),
              g = ui.tree.zTree().getNodeByTId(f);
            d = g.path;
          } else if ($(".file-select-drag-temp").exists())
            (d = ui.fileLight.path($(".file-select-drag-temp"))),
              $(".file-select-drag-temp").hasClass("menu-recycle-button") &&
                (e = "remove");
          else if ($(".children-list-dropover").exists()) {
            var i = $(".children-list-dropover");
            d = i.hasClass("children-list")
              ? pathHashDecode(i.attr("data-path-children"))
              : G.thisPath;
          } else
            $(".split-hover").exists()
              ? (d = ui.fileLight.path($(".split-hover")))
              : (e = $(".recycle-hover").exists()
                  ? "remove"
                  : $(".share-hover").exists() &&
                    1 == ui.fileLight.fileListSelect().length
                  ? "share"
                  : "clear");
        ...
        y = function(a) {
          ...
          if (
            ...
            h
              ...
              .addClass("flipOutXLine")
              .fadeOut(200, function() {
                h.remove(), (h = !1);
              }),
              $(
                ".curDropToPath,.curDropTreeNode,.curDropTreeNode,.file-select-drag-temp,.children-list-dropover"
              ).removeClass(
                "curDropToPath curDropTreeNode curDropTreeNode file-select-drag-temp children-list-dropover"
              );
            ...
            if (
              (L(
                -1 != $.inArray(b, ["copyTo", "moveTo", "remove", "share"])
                  ? !1
                  : !0
              ),
              s(!1),
        ...
        z = function() {
          ...
          $(
            '<div class="file draggable-dragging"><div class="drag-number">' +
              a +
              '</div><span><i class="font-icon bg-default icon-ok"></i>' +
              a +
              " " +
              LNG.file +
              "</span></div>"
        ...
        J = function() {
          ...
          $(
            "<div class='file-continer file-draging-box " +
              b +
              "'><div class='" +
              b +
              " file-draging'></div></div>"
          ).appendTo("body"),
            (t = $(Config.SelectClass).filter("[data-path!='']"));
          var c = t.clone();
          (t.length >= I || $.browser.msie) && (c = i.clone()),
            c.appendTo(".file-draging"),
            c.each(function(a) {
              var b = $(
                  ".bodymain .file-continer .file[data-path='" +
                    $(this).attr("data-path") +
                ...
                d = b.offset();
              $(this).css({ left: d.left, top: d.top, width: b.width() }),
                $(this).data({
                  "data-left": d.left,
                  "data-top": d.top,
                ...
                $(this).attr("data-path") == i.attr("data-path") &&
                  $(this).addClass("handle_target"),
                1 == c.length &&
                  ($(this).data({ "data-animateTime": 0 }), (H = 0));
            }),
                  ...
                  { opacity: 1 },
                  {
                    ...
                    progress: function(b, e, f, g, h) {
                      var i = c.offset(),
                        ...
                        k = (j.left + d - i.left) * e,
                        l = (j.top + d + F - i.top) * e;
                      c.css({ left: i.left + k, top: i.top + l });
                    },
                    complete: function() {
          ...
          $(".file-draging-box").data("dragDelay", d),
            $(".file-draging-box").data("animate", "ready");
        },
        K = function(a, b) {
          return "finished" != $(".file-draging-box").data("animate")
            ? void $(".file-draging .file").each(function() {
                $(this).css({
            ...
            : void $(".file-draging .file").each(function(a) {
                if ("finished" == $(this).data("status")) {
                  ...
                  $(this).css({ left: c.left + b, top: c.top + b + F });
                }
              });
        },
        L = function(a) {
          ...
          clearTimeout($(".file-draging-box").data("dragDelay")),
            $(".file-draging .file").each(function(b) {
              ...
              a
                ...
                : (d.stop().animate({ opacity: 1 }, 100),
                  $(this)
                    .stop()
                    .animate({ opacity: 0 }, 200 + c, function() {
                      $(this).remove();
                    }));
            });
    ...
    u = function() {
      ...
      var m = function(e) {
          (g = l.offset().left - l.scrollLeft()),
            ...
            $(e.target)
              .parent()
              .hasClass(Config.FileBoxClassName) ||
              $(e.target)
                .parent()
                .parent()
                .hasClass(Config.FileBoxClassName) ||
              ...
              ($.contextMenu.hidden(),
              e.ctrlKey || e.metaKey || e.shiftKey || ui.fileLight.clear(),
              $(e.target).hasClass("ico") ||
                ((a = e.pageX - g),
                (b = e.pageY - f),
                (j = setTimeout(function() {
                  (d = !0),
                    0 == $(".select-container").length &&
                      $('<div class="select-container"></div>').appendTo(
                        Config.FileBoxSelector
                      ),
                    (c = $(".select-container"));
                }, 100))));
        ...
        o = function(a, b, c, d) {
          ...
          g !== f && d.stop(!0, !1).animate({ scrollTop: g }, 100);
        },
        p = function() {
          for (
            var a = c.offset().left - l.offset().left + l.scrollLeft(),
              b = c.offset().top - l.offset().top + l.scrollTop(),
              d = a + c.width(),
              e = b + c.height(),
              f = ui.fileLight.fileListAll(),
              g = 0;
            g < f.length;
            g++
          ) {
            ...
            if (
              ("split" == G.userConfig.listType &&
                ((k += i.parents(".split-box")[0].offsetLeft),
                (n = k + i.width())),
              Math.abs(a + d - (k + n)) < d - a + n - k &&
                Math.abs(b + e - (m + o)) < e - b + o - m)
            ) {
              if (!i.hasClass("file-select-drag-temp")) {
                if (i.hasClass("selectToggleClass")) continue;
                if (i.hasClass(Config.SelectClassName)) {
                  i
                    .removeClass(Config.SelectClassName)
                    .addClass("selectToggleClass"),
                    ui.fileLight.resumeMenu(i);
                  continue;
                }
                i.addClass("file-select-drag-temp");
              }
            } else
              i.removeClass("file-select-drag-temp"),
                i.hasClass("selectToggleClass") &&
                  i
                    .addClass(Config.SelectClassName)
                    .removeClass("selectToggleClass");
          }
        },
        q = function(e) {
          return d
            ? (p(),
              ...
              $(".file-select-drag-temp")
                .addClass(Config.SelectClassName)
                .removeClass("file-select-drag-temp"),
              $(".selectToggleClass").removeClass("selectToggleClass"),
              ui.fileLight.select(),
              (d = !1),
              (a = null),
              void (b = null))
    ...
    w = {
      fileListAll: function(a) {
        return "split" != G.userConfig.listType
          ? ui.fileLight.fileListAll()
          : v(a, ".file");
      },
      fileListSelect: function(a) {
        return "split" != G.userConfig.listType
          ? ui.fileLight.fileListSelect()
          : v(a, ".file.select");
      }
    },
    x = function(a) {
    ...
    z = function(a, b) {
      for (
        var c = w.fileListAll(), d = c.eq(a), e = c.length;
        0 != d.parents(".hidden").length;
    ...
    A = function(a) {
      var b,
        ...
        f = !1;
      switch (
        (a.indexOf("shift+") >= 0 && ((f = !0), (a = a.replace("shift+", ""))),
        a)
      ) {
        case "home":
          (e = d.last()), (b = c.first());
    ...
    B = function(a) {
      0 != a.length &&
        (ui.fileLight.clear(),
        a.addClass(Config.SelectClassName),
        ui.fileLight.select(),
        ui.fileLight.setInView(),
        "split" == G.userConfig.listType &&
          1 == a.length &&
          o($(ui.fileLight.fileListSelect()[0])));
    },
    C = function(a) {
      ...
      switch (a) {
        case "left":
          if ("list" == G.userConfig.listType)
            if (1 == b.find(".children-more-cert.cert-open").length)
              b.find(".children-more-cert").removeClass("cert-open"),
                b.next().addClass("hidden");
            else {
            ...
            var c = b
              .parents(".split-box")
              .prev()
              .find(".select-split-parent");
            B(c);
          }
          break;
        case "right":
          if ("list" == G.userConfig.listType)
            1 == b.find(".children-more-cert").length &&
              (ui.fileContent.pathChildrenTree(b),
              b.find(".children-more-cert").addClass("cert-open"),
              b.next().removeClass("hidden"));
          else if ("split" == G.userConfig.listType) {
            var c = b
              .parents(".split-box")
              .next()
    ...
    E = function(a, b, c) {
      var d = ui.getColfileNumberDesktop(),
        ...
        a = { row: a % d, col: parseInt(a / d) },
        b = { row: b % d, col: parseInt(b / d) };
      if (b.row < a.row) {
        var f = b;
        (b = a), (a = f);
      }
...
define("app/src/explorer/fileListResize", [], function(a, b) {
  var c = {
    ...
    e = c,
    f = function() {
      if (LocalData.get("resizeConfig"))
        e = jsonDecode(LocalData.get("resizeConfig"));
      else {
        "undefined" != typeof G.userConfig.resizeConfig &&
          (e = jsonDecode(htmlDecode(G.userConfig.resizeConfig)));
        var a = jsonEncode(e);
      ...
      if ("icon" != G.userConfig.listType) {
        ...
        $.each(a, function(a, b) {
          0 == a.indexOf("file") &&
            ...
            (f += b),
            (c +=
              ".children-list,.file-list-list .file ." +
              a +
              ",#main-title ." +
              a +
              "{width:" +
          ...
          (c +=
            ".children-list,.file-list-list .file{width:" + (f + 50) + "px;}"),
    ...
    l = function() {
      $("#main-title").hasClass("bind-init") ||
        (h(e),
        $("#main-title").addClass("bind-init"),
        $.each(c, function(a, b) {
    ...
    q = function(a, b) {
      ...
      var g = ((a - e) * d) / (f - e),
        ...
        o = j + 3 * h - i,
        q =
          ".file-list-icon div.file,.file-list-icon .flex-empty{height:" +
          k +
          "px;width:" +
          j +
          "px;}";
      core.isApp("desktop") &&
        ((k -= 5),
        (q =
          "div.file-list-icon div.file,.file-list-icon .flex-empty{height:" +
          k +
          "px;width:" +
          j +
          "px;}")),
        $.browser.mozilla && (m -= 4);
      var r =
        "div.file-list-icon div.file{max-height:" +
        o +
        "px;}" +
        q +
        "			.file-list-icon .meta-info{height:" +
        n +
        "px;width:" +
        n +
        "px;				margin-right:" +
        ...
        "px;margin-top:-" +
        1.1 * n +
        "px;}			.file-list-icon div.file .filename{width:" +
        j +
        "px;}			.file-list-icon div.file .filename #pathRenameTextarea,			.file-list-icon div.file .filename .newfile{width:" +
        j +
        "px;}			.file-list-icon div.file .ico{padding-left:" +
        i / 2 +
        "px;height:" +
        m +
        "px;width:" +
        l +
        "px}        	.file-list-icon div.file .ico.picture{width:" +
        l +
        "px;padding-left:" +
        i / 2 +
    ...
    s = function() {
        ...
        if (!(150 > e)) {
          $($(".split-line").get(d)).css("width", e),
            ...
            $(".split-box:gt(" + d + ")").each(function() {
              $(this).hasClass("is-drag-split") ||
                $(this).css(
                  "left",
                  parseInt($(this).data("before_left")) + b + "px"
                );
            });
          var f = [];
          $(".split-box").each(function() {
            f.push({ left: $(this).css("left"), width: $(this).width() });
          }),
      ...
      $(".bodymain .file-list-split .split-drag").drag(
        ...
        $(".split-box").each(function() {
          $('.file[data-path="' + $(this).attr("data-path") + '"]').addClass(
            "select-split-parent"
          );
        }),
        t();
    ...
    t = function() {
      ...
      var c = function(c, d) {
        var e = a[d];
        e || (e = { width: 250, left: b }),
          (b += e.width + 1),
          c.css({ width: e.width + "px", left: e.left });
      };
      (b = 0),
...
define("app/src/explorer/headerAddress", [], function(a, b) {
  var c = function() {
    ...
    d = function(a) {
      ...
      var c = function(a) {
        var b =
            '<li class="yarnlet first"><a title="@1@" data-path="@1@" style="z-index:{$2};"><span class="left-yarn"></span>{$3}</a></li>',
          c =
            '<li class="yarnlet "><a title="@1@" data-path="@1@" style="z-index:{$2};">{$3}</a></li>';
        a = a.replace(/\/+/g, "/");
        var d = a.split("/");
        "" == d[d.length - 1] && d.pop();
        var e = d[0] + "/",
        ...
        if (G.jsonData.info && G.jsonData.info.pathType && "" != d[0]) {
          ...
          (h =
            '<span class="address-ico">' + core.iconSmall(i.icon) + "</span>"),
            (g = i.name);
        }
        (f = f.replace("{$2}", d.length)),
          (f = f.replace(
            "{$3}",
            h + '<span class="title-name">' + htmlEncode(g) + "</span>"
          ));
        for (var j = f, k = 1, l = d.length - 1; k < d.length; k++, l--) {
          ...
          (f = f.replace("{$2}", l)),
            (f = f.replace(
              "{$3}",
              '<span class="title-name">' + htmlEncode(d[k]) + "</span>"
            )),
            (j += f);
        }
    ...
    e = function() {
      ...
      0 >= c
        ? $(".yarnball")
            .css("width", b + "px")
            .css("left", c + "px")
        : $(".yarnball").css({ left: "0px", width: a + "px" });
    },
    f = function(a) {
    ...
    h = function() {
      var a = f();
      if ("/" == a || -1 == a.indexOf("/"))
        return void Tips.tips(LNG.path_is_root_tips, "warning");
      var b = core.pathFather(a);
      ui.path.list(b), d();
    };
  return { init: c, addressSet: d, resetWidth: e, gotoFather: h };
});
define("app/src/explorer/options", [], function(a, b) {
  var c = function() {
      "0" == lodash.get(window, "G.userConfig.fileSelect") &&
        $.addStyle(
          ".file-continer .file .item-select,			.file-continer .file .item-menu{display:none !important;}"
        );
    },
    d = function() {
      "0" == lodash.get(window, "G.userConfig.imageThumb") &&
        Hook.bind("explorer.list.fileThumb", function(a, b) {
